...
`);try{n=new Worker(URL.createObjectURL(new Blob([p])))}catch(b){return typeof console!==void 0&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",b),null}u(n)}return n}}(),L={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function T(n,a){return a?a(n):n}function O(n){return n!=null}function v(n,a,m){return T(n&&O(n[a])?n[a]:L[a],m)}function A(n){return n<0?0:Math.floor(n)}function U(n,a){return Math.floor(Math.random()*(a-n))+n}function N(n){return parseInt(n,16)}function q(n){return n.map(K)}function K(n){var a=String(n).replace(/[^0-9a-f]/gi,"");return a.length<6&&(a=a[0]+a[0]+a[1]+a[1]+a[2]+a[2]),{r:N(a.substring(0,2)),g:N(a.substring(2,4)),b:N(a.substring(4,6))}}function _(n){var a=v(n,"origin",Object);return a.x=v(a,"x",Number),a.y=v(a,"y",Number),a}function V(n){n.width=document.documentElement.clientWidth,n.height=document.documentElement.clientHeight}function M(n){var a=n.getBoundingClientRect();n.width=a.width,n.height=a.height}function z(n){var a=document.createElement("canvas");return a.style.position="fixed",a.style.top="0px",a.style.left="0px",a.style.pointerEvents="none",a.style.zIndex=n,a}function W(n,a,m,u,p,b,y,g,w){n.save(),n.translate(a,m),n.rotate(b),n.scale(u,p),n.arc(0,0,1,y,g,w),n.restore()}function J(n){var a=n.angle*(Math.PI/180),m=n.spread*(Math.PI/180);return{x:n.x,y:n.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:n.startVelocity*.5+Math.random()*n.startVelocity,angle2D:-a+(.5*m-Math.random()*m),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:n.color,shape:n.shape,tick:0,totalTicks:n.ticks,decay:n.decay,drift:n.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:n.gravity*3,ovalScalar:.6,scalar:n.scalar,flat:n.flat}}function ee(n,a){a.x+=Math.cos(a.angle2D)*a.velocity+a.drift,a.y+=Math.sin(a.angle2D)*a.velocity+a.gravity,a.velocity*=a.decay,a.flat?(a.wobble=0,a.wobbleX=a.x+10*a.scalar,a.wobbleY=a.y+10*a.scalar,a.tiltSin=0,a.tiltCos=0,a.random=1):(a.wobble+=a.wobbleSpeed,a.wobbleX=a.x+10*a.scalar*Math.cos(a.wobble),a.wobbleY=a.y+10*a.scalar*Math.sin(a.wobble),a.tiltAngle+=.1,a.tiltSin=Math.sin(a.tiltAngle),a.tiltCos=Math.cos(a.tiltAngle),a.random=Math.random()+2);var m=a.tick++/a.totalTicks,u=a.x+a.random*a.tiltCos,p=a.y+a.random*a.tiltSin,b=a.wobbleX+a.random*a.tiltCos,y=a.wobbleY+a.random*a.tiltSin;if(n.fillStyle="rgba("+a.color.r+", "+a.color.g+", "+a.color.b+", "+(1-m)+")",n.beginPath(),s&&a.shape.type==="path"&&typeof a.shape.path=="string"&&Array.isArray(a.shape.matrix))n.fill($e(a.shape.path,a.shape.matrix,a.x,a.y,Math.abs(b-u)*.1,Math.abs(y-p)*.1,Math.PI/10*a.wobble));else if(a.shape.type==="bitmap"){var g=Math.PI/10*a.wobble,w=Math.abs(b-u)*.1,C=Math.abs(y-p)*.1,I=a.shape.bitmap.width*a.scalar,P=a.shape.bitmap.height*a.scalar,F=new DOMMatrix([Math.cos(g)*w,Math.sin(g)*w,-Math.sin(g)*C,Math.cos(g)*C,a.x,a.y]);F.multiplySelf(new DOMMatrix(a.shape.matrix));var j=n.createPattern(k.transform(a.shape.bitmap),"no-repeat");j.setTransform(F),n.globalAlpha=1-m,n.fillStyle=j,n.fillRect(a.x-I/2,a.y-P/2,I,P),n.globalAlpha=1}else if(a.shape==="circle")n.ellipse?n.ellipse(a.x,a.y,Math.abs(b-u)*a.ovalScalar,Math.abs(y-p)*a.ovalScalar,Math.PI/10*a.wobble,0,2*Math.PI):W(n,a.x,a.y,Math.abs(b-u)*a.ovalScalar,Math.abs(y-p)*a.ovalScalar,Math.PI/10*a.wobble,0,2*Math.PI);else if(a.shape==="star")for(var E=Math.PI/2*3,Y=4*a.scalar,X=8*a.scalar,Z=a.x,re=a.y,le=5,te=Math.PI/le;le--;)Z=a.x+Math.cos(E)*X,re=a.y+Math.sin(E)*X,n.lineTo(Z,re),E+=te,Z=a.x+Math.cos(E)*Y,re=a.y+Math.sin(E)*Y,n.lineTo(Z,re),E+=te;else n.moveTo(Math.floor(a.x),Math.floor(a.y)),n.lineTo(Math.floor(a.wobbleX),Math.floor(p)),n.lineTo(Math.floor(b),Math.floor(y)),n.lineTo(Math.floor(u),Math.floor(a.wobbleY));return n.closePath(),n.fill(),a.tick<a.totalTicks}function H(n,a,m,u,p){var b=a.slice(),y=n.getContext("2d"),g,w,C=f(function(I){function P(){g=w=null,y.clearRect(0,0,u.width,u.height),k.clear(),p(),I()}function F(){o&&!(u.width===r.width&&u.height===r.height)&&(u.width=n.width=r.width,u.height=n.height=r.height),!u.width&&!u.height&&(m(n),u.width=n.width,u.height=n.height),y.clearRect(0,0,u.width,u.height),b=b.filter(function(j){return ee(y,j)}),b.length?g=h.frame(F):P()}g=h.frame(F),w=P});return{addFettis:function(I){return b=b.concat(I),C},canvas:n,promise:C,reset:function(){g&&h.cancel(g),w&&w()}}}function ne(n,a){var m=!n,u=!!v(a||{},"resize"),p=!1,b=v(a,"disableForReducedMotion",Boolean),y=i&&!!v(a||{},"useWorker"),g=y?x():null,w=m?V:M,C=n&&g?!!n.__confetti_initialized:!1,I=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,P;function F(E,Y,X){for(var Z=v(E,"particleCount",A),re=v(E,"angle",Number),le=v(E,"spread",Number),te=v(E,"startVelocity",Number),qe=v(E,"decay",Number),Ye=v(E,"gravity",Number),He=v(E,"drift",Number),Ae=v(E,"colors",q),Ge=v(E,"ticks",Number),ze=v(E,"shapes"),Ke=v(E,"scalar"),Je=!!v(E,"flat"),Ie=_(E),Fe=Z,Se=[],Xe=n.width*Ie.x,Ze=n.height*Ie.y;Fe--;)Se.push(J({x:Xe,y:Ze,angle:re,spread:le,startVelocity:te,color:Ae[Fe%Ae.length],shape:ze[U(0,ze.length)],ticks:Ge,decay:qe,gravity:Ye,drift:He,scalar:Ke,flat:Je}));return P?P.addFettis(Se):(P=H(n,Se,w,Y,X),P.promise)}function j(E){var Y=b||v(E,"disableForReducedMotion",Boolean),X=v(E,"zIndex",Number);if(Y&&I)return f(function(te){te()});m&&P?n=P.canvas:m&&!n&&(n=z(X),document.body.appendChild(n)),u&&!C&&w(n);var Z={width:n.width,height:n.height};g&&!C&&g.init(n),C=!0,g&&(n.__confetti_initialized=!0);function re(){if(g){var te={getBoundingClientRect:function(){if(!m)return n.getBoundingClientRect()}};w(te),g.postMessage({resize:{width:te.width,height:te.height}});return}Z.width=Z.height=null}function le(){P=null,u&&(p=!1,e.removeEventListener("resize",re)),m&&n&&(document.body.contains(n)&&document.body.removeChild(n),n=null,C=!1)}return u&&!p&&(p=!0,e.addEventListener("resize",re,!1)),g?g.fire(E,Z,le):F(E,Z,le)}return j.reset=function(){g&&g.reset(),P&&P.reset()},j}var se;function Me(){return se||(se=ne(null,{useWorker:!0,resize:!0})),se}function $e(n,a,m,u,p,b,y){var g=new Path2D(n),w=new Path2D;w.addPath(g,new DOMMatrix(a));var C=new Path2D;return C.addPath(w,new DOMMatrix([Math.cos(y)*p,Math.sin(y)*p,-Math.sin(y)*b,Math.cos(y)*b,m,u])),C}function Ue(n){if(!s)throw new Error("path confetti are not supported in this browser");var a,m;typeof n=="string"?a=n:(a=n.path,m=n.matrix);var u=new Path2D(a),p=document.createElement("canvas"),b=p.getContext("2d");if(!m){for(var y=1e3,g=y,w=y,C=0,I=0,P,F,j=0;j<y;j+=2)for(var E=0;E<y;E+=2)b.isPointInPath(u,j,E,"nonzero")&&(g=Math.min(g,j),w=Math.min(w,E),C=Math.max(C,j),I=Math.max(I,E));P=C-g,F=I-w;var Y=10,X=Math.min(Y/P,Y/F);m=[X,0,0,X,-Math.round(P/2+g)*X,-Math.round(F/2+w)*X]}return{type:"path",path:a,matrix:m}}function Ve(n){var a,m=1,u="#000000",p='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof n=="string"?a=n:(a=n.text,m="scalar"in n?n.scalar:m,p="fontFamily"in n?n.fontFamily:p,u="color"in n?n.color:u);var b=10*m,y=""+b+"px "+p,g=new OffscreenCanvas(b,b),w=g.getContext("2d");w.font=y;var C=w.measureText(a),I=Math.ceil(C.actualBoundingBoxRight+C.actualBoundingBoxLeft),P=Math.ceil(C.actualBoundingBoxAscent+C.actualBoundingBoxDescent),F=2,j=C.actualBoundingBoxLeft+F,E=C.actualBoundingBoxAscent+F;I+=F+F,P+=F+F,g=new OffscreenCanvas(I,P),w=g.getContext("2d"),w.font=y,w.fillStyle=u,w.fillText(a,j,E);var Y=1/m;return{type:"bitmap",bitmap:g.transferToImageBitmap(),matrix:[Y,0,0,Y,-I*Y/2,-P*Y/2]}}t.exports=function(){return Me().apply(this,arguments)},t.exports.reset=function(){Me().reset()},t.exports.create=ne,t.exports.shapeFromPath=Ue,t.exports.shapeFromText=Ve})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Le,!1);const mt=Le.exports;Le.exports.create;const gt="modulepreload",ut=function(l,e){return new URL(l,e).href},_e={},ke=function(e,t,o){let r=Promise.resolve();if(t&&t.length>0){const s=document.getElementsByTagName("link"),c=document.querySelector("meta[property=csp-nonce]"),d=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));r=Promise.allSettled(t.map(f=>{if(f=ut(f,o),f in _e)return;_e[f]=!0;const k=f.endsWith(".css"),h=k?'[rel="stylesheet"]':"";if(!!o)for(let T=s.length-1;T>=0;T--){const O=s[T];if(O.href===f&&(!k||O.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${f}"]${h}`))return;const L=document.createElement("link");if(L.rel=k?"stylesheet":gt,k||(L.as="script"),L.crossOrigin="",L.href=f,d&&L.setAttribute("nonce",d),document.head.appendChild(L),k)return new Promise((T,O)=>{L.addEventListener("load",T),L.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${f}`)))})}))}function i(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return r.then(s=>{for(const c of s||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},de=pe("Preferences",{web:()=>ke(()=>import("./web.B9AtMyaB.js"),[],import.meta.url).then(l=>new l.PreferencesWeb)});var ye,$;class S{static async initialize(){if(!R(this,ye))try{const e=await this.get(this.KEYS.SETTINGS);e?G(this,$,e):await this.set(this.KEYS.SETTINGS,R(this,$)),G(this,ye,!0),console.log("✅ Storage inicializado:",R(this,$))}catch(e){console.error("❌ Error inicializando Storage:",e)}}static async get(e,t=null){try{const{value:o}=await de.get({key:e});return o?JSON.parse(o):t}catch{try{const r=localStorage.getItem(e);return r?JSON.parse(r):t}catch(r){return console.error(`Error leyendo ${e}:`,r),t}}}static async set(e,t){try{return await de.set({key:e,value:JSON.stringify(t)}),e===this.KEYS.SETTINGS&&G(this,$,t),!0}catch{try{return localStorage.setItem(e,JSON.stringify(t)),e===this.KEYS.SETTINGS&&G(this,$,t),!0}catch(r){return console.error(`Error guardando ${e}:`,r),!1}}}static get isVibrationEnabled(){return R(this,$).vibrationEnabled}static get isNotificationEnabled(){return R(this,$).notificationEnabled}static async setVibrationEnabled(e){return R(this,$).vibrationEnabled=e,this.set(this.KEYS.SETTINGS,R(this,$))}static async setNotificationEnabled(e){return R(this,$).notificationEnabled=e,this.set(this.KEYS.SETTINGS,R(this,$))}static async getCurrentLevel(){return this.get(this.KEYS.CURRENT_LEVEL)}static async setCurrentLevel(e){return this.set(this.KEYS.CURRENT_LEVEL,e)}static async getCurrentTheme(){return this.get(this.KEYS.THEME)}static async setCurrentTheme(e){return this.set(this.KEYS.THEME,e)}static async resetToDefaults(){G(this,$,{vibrationEnabled:!0,notificationEnabled:!0}),await Promise.all([this.set(this.KEYS.SETTINGS,R(this,$)),this.set(this.KEYS.THEME,"dark"),this.set(this.KEYS.CURRENT_LEVEL,Q[0])])}}ye=new WeakMap,$=new WeakMap,be(S,"KEYS",{THEME:"theme",CURRENT_LEVEL:"currentLevel",SETTINGS:"settings"}),me(S,ye,!1),me(S,$,{vibrationEnabled:!0,notificationEnabled:!0});var je;(function(l){l[l.Sunday=1]="Sunday",l[l.Monday=2]="Monday",l[l.Tuesday=3]="Tuesday",l[l.Wednesday=4]="Wednesday",l[l.Thursday=5]="Thursday",l[l.Friday=6]="Friday",l[l.Saturday=7]="Saturday"})(je||(je={}));const ce=pe("LocalNotifications",{web:()=>ke(()=>import("./web.StJlb_io.js"),[],import.meta.url).then(l=>new l.LocalNotificationsWeb)}),we=pe("App",{web:()=>ke(()=>import("./web.BrhdOWVe.js"),[],import.meta.url).then(l=>new l.AppWeb)});var Ee;(function(l){l.Heavy="HEAVY",l.Medium="MEDIUM",l.Light="LIGHT"})(Ee||(Ee={}));var Ce;(function(l){l.Success="SUCCESS",l.Warning="WARNING",l.Error="ERROR"})(Ce||(Ce={}));const ve=pe("Haptics",{web:()=>ke(()=>import("./web.raELmqCY.js"),[],import.meta.url).then(l=>new l.HapticsWeb)});var ae,ue,fe;class B{static get isInitialized(){return R(this,ae)}static async initialize(){if(R(this,ae))return console.log("[Capacitor] Ya inicializado"),!0;console.group("[Capacitor] Inicializando servicios");try{return console.log("[Capacitor] Detectando plataforma..."),console.log("[Capacitor] Estado:",{platform:D.platform,isNative:D.isNative,getPlatform:D.getPlatform()}),D.isNative?(console.log("[Capacitor] Configurando servicios nativos"),await this.setupNativeServices(),G(this,ae,!0),console.log("[Capacitor] ✅ Servicios nativos listos"),console.groupEnd(),!0):(console.log("[Capacitor] Usando web fallbacks"),await this.setupWebServices(),G(this,ae,!0),console.groupEnd(),!0)}catch(e){return console.error("[Capacitor] ❌ Error:",e),console.groupEnd(),G(this,ae,!0),!1}}static async setupWebServices(){console.group("[Capacitor] Configurando servicios web");try{if("serviceWorker"in navigator&&(G(this,fe,await navigator.serviceWorker.register("./sw.js",{scope:"./",type:"classic",updateViaCache:"none",credentials:"same-origin"})),console.log("✅ Service Worker registrado"),await navigator.serviceWorker.ready),"Notification"in window){const e=await Notification.requestPermission();console.log("- Permisos de notificación:",e)}"serviceWorker"in navigator&&console.log("- Service Worker disponible"),"vibrate"in navigator&&console.log("- Vibración disponible"),console.log("✅ Servicios web configurados")}catch(e){console.error("❌ Error configurando servicios web:",e)}console.groupEnd()}static async setupNativeServices(){console.group("[Capacitor] Configurando servicios nativos");const e=[{name:"App",instance:we},{name:"Haptics",instance:ve},{name:"LocalNotifications",instance:ce},{name:"Preferences",instance:de}];for(const{name:t,instance:o}of e)try{const r=D.isPluginAvailable(t);if(console.log(`- ${t}: ${r?"✓":"✗"}`),r&&o&&t==="LocalNotifications"){const i=await o.checkPermissions();console.log(`  Permisos: ${i.display}`)}}catch(r){console.warn(`❌ Error verificando ${t}:`,r)}this.setupAppListeners(),console.log("✅ Configuración nativa completada"),console.groupEnd()}static async setupWebNotifications(){if("Notification"in window){const e=await Notification.requestPermission();console.log("Permisos de notificación web:",e)}}static async setupServiceWorker(){if(!R(this,ae))try{if(this.setupAppListeners(),G(this,ue,D.isNative),console.log("Plataforma nativa:",R(this,ue)),"serviceWorker"in navigator)try{!(window.location.hostname==="localhost"||window.location.hostname.includes("192.168.")||window.location.hostname.includes("127.0.0.1"))||window.location.protocol==="http:"?(G(this,fe,await navigator.serviceWorker.register("/sw.js",{scope:"/",type:"classic",updateViaCache:"none"})),console.log("✅ Service Worker registrado:",R(this,fe))):console.log("Service Worker no registrado en desarrollo local")}catch(e){console.warn("Service Worker no disponible:",e)}G(this,ae,!0),console.log("✅ Servicios nativos inicializados")}catch(e){console.error("❌ Error inicializando servicios nativos:",e)}}static setupAppListeners(){we.addListener("backButton",({canGoBack:e})=>{e||we.exitApp()}),we.addListener("appStateChange",({isActive:e})=>{e?document.dispatchEvent(new Event("appResume")):document.dispatchEvent(new Event("appPause"))})}static async initializeNotifications(){var e;if(console.group("🔔 Inicializando sistema de notificaciones"),R(this,ue))try{console.log("📱 Intentando usar notificaciones nativas...");const{display:t}=await ce.checkPermissions();if(console.log("Estado de permisos nativos:",t),t==="granted"||t==="prompt"){const o=await ce.requestPermissions();if(console.log("Nuevos permisos nativos:",o.display),o.display==="granted"){console.log("✅ Notificaciones nativas activadas"),console.groupEnd();return}}}catch(t){console.warn("❌ Notificaciones nativas no disponibles:",t)}if("Notification"in window)try{let t=Notification.permission;if(t==="default"&&(console.log("📱 Solicitando permisos de notificación..."),t=await Notification.requestPermission()),t==="granted"){(e=R(this,fe))!=null&&e.active?console.log("✅ Service Worker notifications activadas"):console.log("✅ Web Notifications activadas"),console.groupEnd();return}else console.warn("❌ Permisos de notificación denegados:",t)}catch(t){console.warn("❌ Error solicitando permisos:",t)}console.warn("❌ No hay sistema de notificaciones disponible"),console.groupEnd()}static async vibrate(e="MEDIUM"){try{switch(e.toUpperCase()){case"LIGHT":await ve.impact({style:Ee.Light});break;case"HEAVY":await ve.notification({type:Ce.Success});break;case"MEDIUM":default:await ve.impact({style:Ee.Medium})}return!0}catch{return console.warn("Haptics no disponible"),!1}}static getIconPath(){console.group("🖼️ Obteniendo rutas de iconos");const e=D.getPlatform()==="android",o=D.isNative&&e?"ic_notification":"./assets/images/icon.png";return console.log("Icono seleccionado:",o),console.groupEnd(),o}static async sendNotification(e,t){console.group("📱 Enviando notificación");try{const o=this.getIconPath(),r=D.getPlatform()==="android";if(D.isNative&&r){console.log("Usando notificaciones Android nativas");const i=await ce.requestPermissions();if(console.log("Permisos:",i),i.display!=="granted")throw new Error("Permiso denegado en Android");await ce.schedule({notifications:[{title:e,body:t,id:Date.now(),schedule:{at:new Date},autoCancel:!0,smallIcon:o,android:{channelId:"default",importance:4,priority:3,visibility:1,smallIcon:o}}]}),console.log("✅ Notificación Android enviada")}else{if(console.log("Usando notificaciones web"),!("serviceWorker"in navigator))throw new Error("Service Worker no soportado");const i=await navigator.serviceWorker.ready;if(console.log("Service Worker listo"),Notification.permission!=="granted"){const s=await Notification.requestPermission();if(console.log("Permiso de notificación:",s),s!=="granted")throw new Error("Permiso denegado")}await i.showNotification(e,{body:t,icon:o,vibrate:[200,100,200],requireInteraction:!0,actions:[{action:"open",title:"Abrir"}],data:{url:window.location.origin,timestamp:Date.now()}}),console.log("✅ Notificación web enviada")}}catch(o){throw console.error("❌ Error en notificación:",o),o}finally{console.groupEnd()}}static async scheduleNativeNotification(e,t,o){console.group("📱 Programando notificación nativa");try{console.log("Cancelando notificaciones anteriores..."),await ce.cancel({notifications:[{id:1}]});const r=new Date(Date.now()+o*60*60*1e3);return console.log("Tiempo programado:",r),await ce.schedule({notifications:[{title:e,body:t,id:1,schedule:{at:r,allowWhileIdle:!0},actionTypeId:"OPEN_APP"}]}),console.log("✅ Notificación nativa programada"),console.groupEnd(),!0}catch(r){return console.error("❌ Error en notificación nativa:",r),console.groupEnd(),!1}}static isMobile(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"maxTouchPoints"in navigator&&navigator.maxTouchPoints>0}static async scheduleMobileNotification(e,t){console.group("📱 Programando Service Worker notification");try{const o=await navigator.serviceWorker.ready;return console.log("Service Worker listo"),await o.showNotification(e,{body:t,icon:"./assets/images/icon.png",vibrate:[200,100,200]}),console.log("✅ Service Worker notification mostrada"),console.groupEnd(),!0}catch(o){return console.error("❌ Error en Service Worker notification:",o),console.groupEnd(),!1}}static async saveData(e,t){try{return await de.set({key:e,value:JSON.stringify(t)}),!0}catch{return console.warn("Error guardando en Preferences, usando localStorage"),localStorage.setItem(e,JSON.stringify(t)),!1}}static async getData(e,t=null){try{const{value:o}=await de.get({key:e});return o?JSON.parse(o):t}catch{console.warn("Error leyendo de Preferences, usando localStorage");const o=localStorage.getItem(e);return o?JSON.parse(o):t}}static async removeData(e){try{return await de.remove({key:e}),!0}catch{return localStorage.removeItem(e),!1}}static async clearData(){try{return await de.clear(),!0}catch{return localStorage.clear(),!1}}static async logToNative(e,t={}){this._recentLogs||(this._recentLogs=new Set);const o=`${e}-${JSON.stringify(t)}`;this._recentLogs.has(o)||(this._recentLogs.add(o),setTimeout(()=>this._recentLogs.delete(o),1e3),D.getPlatform()==="android"?console.debug(`[GameSalad] ${e}`,JSON.stringify(t,null,2)):console.log(e,t))}}ae=new WeakMap,ue=new WeakMap,fe=new WeakMap,me(B,ae,!1),me(B,ue,!1),me(B,fe,null);class oe{static async measureText(e,t){const o=document.createElement("div");o.style.cssText=`
        ...
        `,o.textContent=e,document.body.appendChild(o);const r={width:o.offsetWidth,height:o.offsetHeight,left:o.offsetLeft,top:o.offsetTop};return document.body.removeChild(o),r}static animateWordFound(e,t,o){return new Promise(r=>{const i=document.getElementById(`tile-${e[e.length-1]}`),s=i.querySelector(".text"),c=t.querySelector("span");c.style.opacity="0";const d=window.getComputedStyle(c),f={source:window.getComputedStyle(s),target:window.getComputedStyle(t)};(async()=>{const k=await Promise.all([...o].map(async A=>this.measureText(A,{"font-size":d.fontSize,"font-family":"var(--font-family-content)","font-weight":f.target.fontWeight,"letter-spacing":f.target.letterSpacing,"text-transform":f.target.textTransform,"font-feature-settings":f.target.fontFeatureSettings}))),h=k.reduce((A,U)=>A+U.width,0),x=c.getBoundingClientRect(),L=i.getBoundingClientRect(),T=(x.width-h)/2,O=[...o].map((A,U)=>{const N=document.createElement("span");N.textContent=A===" "?" ":A,N.className="animated-letter";const q=L.left+L.width/2,K=L.top+L.height/2;N.style.cssText=`
                        ...
                        opacity: 1;
                    `,document.body.appendChild(N);const _=k.slice(0,U).reduce((z,W)=>z+W.width,0),V=x.left+T+_+k[U].width/2,M=x.top+x.height/2;return{element:N,endX:V,endY:M,startX:q,startY:K,sourceStyles:f.source,targetStyles:f.target}});O.forEach(({element:A,endX:U,endY:N,startX:q,startY:K},_)=>{setTimeout(()=>{A.classList.add("animating"),requestAnimationFrame(()=>{A.classList.add("in-transit");const V=U-q,M=N-K;A.style.cssText+=`
...
`)}findThemeStylesInCss(e){const t=`[data-theme='${e}']`,o=xe;let r=o.indexOf(t);if(r===-1)return null;let i=0,s=r,c=!1;for(let d=r;d<o.length;d++){const f=o[d];if(f==="{"?(i++,c=!0):f==="}"&&i--,c&&i===0){s=d+1;break}}return o.substring(r,s)}async initialize(){console.group("[ThemeSelector] Inicializando");try{const e=await S.get(S.KEYS.THEME,"dark");return console.log("Tema guardado:",e),this._pendingTheme=e,await this.injectBaseStyles(),this.loadThemeData(),console.log("✅ ThemeSelector preparado"),!0}catch(e){return console.error("❌ Error:",e),document.documentElement.setAttribute("data-theme","dark"),!1}finally{console.groupEnd()}}async applyPendingTheme(){if(this._pendingTheme){console.log("🎨 Aplicando tema:",this._pendingTheme);try{await this.loadFontsForTheme(this._pendingTheme),document.documentElement.setAttribute("data-theme",this._pendingTheme),this._activeTheme=this._pendingTheme,await document.fonts.ready,await new Promise(e=>setTimeout(e,100)),this._pendingTheme=null,console.log("✅ Tema aplicado")}catch(e){console.error("❌ Error aplicando tema:",e)}}}async parseFonts(e){const t=/@import url\(['"]([^'"]+)['"]\);/g,o=new Set;let r;for(;(r=t.exec(e))!==null;)o.add(r[1]);return Array.from(o)}async loadFontsForTheme(e){try{const o=(await this.parseFonts(xe)).map(r=>{const i=document.createElement("link");return i.rel="stylesheet",i.href=r,i});await Promise.all(o.map(r=>new Promise((i,s)=>{r.onload=()=>i(),r.onerror=()=>s(),document.head.appendChild(r)}))),await document.fonts.ready,console.log("✅ Fuentes cargadas para el tema:",e)}catch(t){console.error("❌ Error cargando fuentes:",t)}}async preloadFontsForTheme(e){try{console.log("🔤 Precargando fuentes para:",e);const o=(await this.parseFonts(xe)).map(r=>{const i=document.createElement("link");return i.rel="stylesheet",i.href=r,i});await Promise.all(o.map(r=>new Promise(i=>{r.onload=i,r.onerror=i,document.head.appendChild(r)}))),await document.fonts.ready,console.log("✅ Fuentes cargadas")}catch(t){console.error("❌ Error cargando fuentes:",t)}}async setTheme(e){if(this._activeTheme===e)return!0;try{return console.group("🎨 Cambiando tema a:",e),await this.loadFontsForTheme(e),document.documentElement.setAttribute("data-theme",e),this._activeTheme=e,await document.fonts.ready,await S.setCurrentTheme(e),window.dispatchEvent(new CustomEvent("themechange",{detail:{theme:e}})),console.log("✅ Tema aplicado"),console.groupEnd(),!0}catch(t){return console.error("❌ Error aplicando tema:",t),console.groupEnd(),!1}}}class bt{constructor(e){this.titleElement=e,this.observer=new MutationObserver(()=>this.fit()),this.observe(),this.bindEvents()}observe(){this.observer.observe(this.titleElement,{childList:!0,characterData:!0,subtree:!0})}bindEvents(){window.addEventListener("resize",()=>{requestAnimationFrame(()=>this.fit())})}async fit(e=1){if(!this._fitInProgress){this._fitInProgress=!0;try{const r=this.titleElement,i=r.parentElement,s=D.getPlatform()==="android",c=getComputedStyle(i),d=i.clientWidth,f=parseFloat(c.paddingLeft)+parseFloat(c.paddingRight),k=s?d*.05:Math.min(16,d*.03),h=d-f-k;r.style="",await document.fonts.ready,r.style.display="inline-block",r.offsetWidth;const x=getComputedStyle(r),L=parseFloat(x.fontSize),T=document.createElement("span");T.style.cssText=`
                ...
                font-size: ${L}px;
            `,T.textContent=r.textContent,document.body.appendChild(T);const O=T.offsetWidth;if(document.body.removeChild(T),e===1&&await B.logToNative(`📏 [${s?"Android":"Web"}] Ajuste inicial`,{texto:r.textContent,contenedor:Math.round(d),disponible:Math.round(h),anchoActual:Math.round(O)}),O>h){const v=s?.5:.85,A=.15*(e-1),U=Math.max(.3,v-A),N=h/O*U*.9,q=s?14:18,K=s?d*.05:d*.08;let _=Math.floor(Math.max(q,Math.min(L*N,K)));for(await B.logToNative("📊 Cálculos",{factorEscala:U,escalaFinal:N.toFixed(2),fuenteMinima:Math.round(q),fuenteNueva:_,maximoPermitido:Math.round(K)});_>=q;){r.style.fontSize=`${_}px`,r.offsetWidth,await new Promise(z=>requestAnimationFrame(z)),T.style.fontSize=`${_}px`,document.body.appendChild(T);const V=T.offsetWidth;document.body.removeChild(T);const M={anchoFinal:Math.round(V),anchoDisponible:Math.round(h),ajustado:V<=h,porcentajeReduccion:Math.round((1-_/L)*100)};if(await B.logToNative("📐 Resultado",M),V<=h){await B.logToNative("✅ Ajuste completado");return}if(_=Math.floor(_*.9),_<q)break}if(e<3)return await B.logToNative("⚠️ Reintentando ajuste..."),await new Promise(V=>setTimeout(V,50)),this.fit(e+1)}else await B.logToNative("✅ No necesita ajuste")}catch(r){console.error("Error ajustando título:",r)}finally{this._fitInProgress=!1,this.titleElement.style.display=""}}}destroy(){this.observer.disconnect()}}const ge=class ge{constructor(){if(ge.instance)return ge.instance;ge.instance=this,console.group("🎮 GameState Constructor");const e="base-styles";if(!document.getElementById(e)){console.log("💉 Inyectando estilos base...");const t=document.createElement("style");t.id=e,t.textContent=`
                @keyframes rotation {
