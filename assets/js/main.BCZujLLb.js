var Qe=Object.defineProperty;var Oe=l=>{throw TypeError(l)};var et=(l,e,t)=>e in l?Qe(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t;var be=(l,e,t)=>et(l,typeof e!="symbol"?e+"":e,t),Ne=(l,e,t)=>e.has(l)||Oe("Cannot "+t);var R=(l,e,t)=>(Ne(l,e,"read from private field"),t?t.call(l):e.get(l)),me=(l,e,t)=>e.has(l)?Oe("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(l):e.set(l,t),G=(l,e,t,o)=>(Ne(l,e,"write to private field"),o?o.call(l,t):e.set(l,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();/*! Capacitor: https://capacitorjs.com/ - MIT License */var he;(function(l){l.Unimplemented="UNIMPLEMENTED",l.Unavailable="UNAVAILABLE"})(he||(he={}));class Te extends Error{constructor(e,t,o){super(e),this.message=e,this.code=t,this.data=o}}const tt=l=>{var e,t;return l!=null&&l.androidBridge?"android":!((t=(e=l==null?void 0:l.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},ot=l=>{const e=l.CapacitorCustomPlatform||null,t=l.Capacitor||{},o=t.Plugins=t.Plugins||{},r=()=>e!==null?e.name:tt(l),i=()=>r()!=="web",s=h=>{const x=f.get(h);return!!(x!=null&&x.platforms.has(r())||c(h))},c=h=>{var x;return(x=t.PluginHeaders)===null||x===void 0?void 0:x.find(L=>L.name===h)},d=h=>l.console.error(h),f=new Map,k=(h,x={})=>{const L=f.get(h);if(L)return console.warn(`Capacitor plugin "${h}" already registered. Cannot register plugins twice.`),L.proxy;const T=r(),O=c(h);let v;const A=async()=>(!v&&T in x?v=typeof x[T]=="function"?v=await x[T]():v=x[T]:e!==null&&!v&&"web"in x&&(v=typeof x.web=="function"?v=await x.web():v=x.web),v),U=(M,z)=>{var W,J;if(O){const ee=O==null?void 0:O.methods.find(H=>z===H.name);if(ee)return ee.rtype==="promise"?H=>t.nativePromise(h,z.toString(),H):(H,ne)=>t.nativeCallback(h,z.toString(),H,ne);if(M)return(W=M[z])===null||W===void 0?void 0:W.bind(M)}else{if(M)return(J=M[z])===null||J===void 0?void 0:J.bind(M);throw new Te(`"${h}" plugin is not implemented on ${T}`,he.Unimplemented)}},N=M=>{let z;const W=(...J)=>{const ee=A().then(H=>{const ne=U(H,M);if(ne){const se=ne(...J);return z=se==null?void 0:se.remove,se}else throw new Te(`"${h}.${M}()" is not implemented on ${T}`,he.Unimplemented)});return M==="addListener"&&(ee.remove=async()=>z()),ee};return W.toString=()=>`${M.toString()}() { [capacitor code] }`,Object.defineProperty(W,"name",{value:M,writable:!1,configurable:!1}),W},q=N("addListener"),K=N("removeListener"),j=(M,z)=>{const W=q({eventName:M},z),J=async()=>{const H=await W;K({eventName:M,callbackId:H},z)},ee=new Promise(H=>W.then(()=>H({remove:J})));return ee.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await J()},ee},V=new Proxy({},{get(M,z){switch(z){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return O?j:q;case"removeListener":return K;default:return N(z)}}});return o[h]=V,f.set(h,{name:h,proxy:V,platforms:new Set([...Object.keys(x),...O?[T]:[]])}),V};return t.convertFileSrc||(t.convertFileSrc=h=>h),t.getPlatform=r,t.handleError=d,t.isNativePlatform=i,t.isPluginAvailable=s,t.registerPlugin=k,t.Exception=Te,t.DEBUG=!!t.DEBUG,t.isLoggingEnabled=!!t.isLoggingEnabled,t},at=l=>l.Capacitor=ot(l),D=at(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),pe=D.registerPlugin;class We{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let o=!1;this.listeners[e]||(this.listeners[e]=[],o=!0),this.listeners[e].push(t);const i=this.windowListeners[e];i&&!i.registered&&this.addWindowListener(i),o&&this.sendRetainedArgumentsForEvent(e);const s=async()=>this.removeListener(e,t);return Promise.resolve({remove:s})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,o){const r=this.listeners[e];if(!r){if(o){let i=this.retainedEventArguments[e];i||(i=[]),i.push(t),this.retainedEventArguments[e]=i}return}r.forEach(i=>i(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:o=>{this.notifyListeners(t,o)}}}unimplemented(e="not implemented"){return new D.Exception(e,he.Unimplemented)}unavailable(e="not available"){return new D.Exception(e,he.Unavailable)}async removeListener(e,t){const o=this.listeners[e];if(!o)return;const r=o.indexOf(t);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(o=>{this.notifyListeners(e,o)}))}}const Re=l=>encodeURIComponent(l).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),De=l=>l.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class rt extends We{async getCookies(){const e=document.cookie,t={};return e.split(";").forEach(o=>{if(o.length<=0)return;let[r,i]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=De(r).trim(),i=De(i).trim(),t[r]=i}),t}async setCookie(e){try{const t=Re(e.key),o=Re(e.value),r=`; expires=${(e.expires||"").replace("expires=","")}`,i=(e.path||"/").replace("path=",""),s=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${t}=${o||""}${r}; path=${i}; ${s};`}catch(t){return Promise.reject(t)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(t){return Promise.reject(t)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const t of e)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}pe("CapacitorCookies",{web:()=>new rt});const it=async l=>new Promise((e,t)=>{const o=new FileReader;o.onload=()=>{const r=o.result;e(r.indexOf(",")>=0?r.split(",")[1]:r)},o.onerror=r=>t(r),o.readAsDataURL(l)}),st=(l={})=>{const e=Object.keys(l);return Object.keys(l).map(r=>r.toLocaleLowerCase()).reduce((r,i,s)=>(r[i]=l[e[s]],r),{})},nt=(l,e=!0)=>l?Object.entries(l).reduce((o,r)=>{const[i,s]=r;let c,d;return Array.isArray(s)?(d="",s.forEach(f=>{c=e?encodeURIComponent(f):f,d+=`${i}=${c}&`}),d.slice(0,-1)):(c=e?encodeURIComponent(s):s,d=`${i}=${c}`),`${o}&${d}`},"").substr(1):null,lt=(l,e={})=>{const t=Object.assign({method:l.method||"GET",headers:l.headers},e),r=st(l.headers)["content-type"]||"";if(typeof l.data=="string")t.body=l.data;else if(r.includes("application/x-www-form-urlencoded")){const i=new URLSearchParams;for(const[s,c]of Object.entries(l.data||{}))i.set(s,c);t.body=i.toString()}else if(r.includes("multipart/form-data")||l.data instanceof FormData){const i=new FormData;if(l.data instanceof FormData)l.data.forEach((c,d)=>{i.append(d,c)});else for(const c of Object.keys(l.data))i.append(c,l.data[c]);t.body=i;const s=new Headers(t.headers);s.delete("content-type"),t.headers=s}else(r.includes("application/json")||typeof l.data=="object")&&(t.body=JSON.stringify(l.data));return t};class ct extends We{async request(e){const t=lt(e,e.webFetchExtra),o=nt(e.params,e.shouldEncodeUrlParams),r=o?`${e.url}?${o}`:e.url,i=await fetch(r,t),s=i.headers.get("content-type")||"";let{responseType:c="text"}=i.ok?e:{};s.includes("application/json")&&(c="json");let d,f;switch(c){case"arraybuffer":case"blob":f=await i.blob(),d=await it(f);break;case"json":d=await i.json();break;case"document":case"text":default:d=await i.text()}const k={};return i.headers.forEach((h,x)=>{k[x]=h}),{data:d,headers:k,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}pe("CapacitorHttp",{web:()=>new ct});const dt=[{id:"vg_characters",name:"VG Characters",data:{SONIC:"a1b1c1d1c2","LARA CROFT":"a3b3c4d3c2d2c3b2a2",MARIO:"d4d3c4b4a4"}},{id:"chess",name:"Ajedrez",data:{PAWN:"a1a2a3b3",QUEEN:"d4c4b4a4b3",KING:"c3c2b3b2",KNIGHT:"c3b3c2b2c1d1",BISHOP:"d3c2d2c1b1a1"}},{id:"planets",name:"Planetas",data:{MARS:"c4b3c3b4",MERCURY:"c4d4c3d2c2d1c1",NEPTUNE:"a3a2b1b2c2d3d4",SATURN:"b4b3b2c2c3d3",URANUS:"c2c3b3a3a4b4",VENUS:"a1a2a3a4b4"}}],ie=dt.reduce((l,{id:e,name:t,data:o})=>(l[e]={name:t,data:o},l),{}),Q=Object.keys(ie);class ft{constructor(e,t,o){this.board=e,this.board.querySelectorAll("svg").forEach(r=>r.remove()),this.svgContainer=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgContainer.id="lines",this.board.insertBefore(this.svgContainer,this.board.firstChild),this.onSelectionUpdate=o,this.selected=[],this._isPointerDown=!1,this._isDragging=!1,this.potentialUndo=null,this.startedInsideBoard=!1,this._lastTouchMove=null,this._lastTouchEvent=null,this._wasSelecting=!1}reset(){this.selected.forEach(e=>document.getElementById(`mark-${e}`).classList.remove("selected")),this.svgContainer.innerHTML="",this.selected=[],this.potentialUndo=null}resetControls(){[this._isPointerDown,this._isDragging,this.potentialUndo,this.startedInsideBoard]=[!1,!1,null,!1]}getCurrentSelection(){return[...this.selected]}drawLine(){this.svgContainer.innerHTML="",this.selected.forEach((e,t)=>{if(t===0)return;const o=document.createElementNS("http://www.w3.org/2000/svg","line"),[r,i]=[this.selected[t-1],e].map(c=>document.getElementById(`mark-${c}`).getBoundingClientRect()),s=this.board.getBoundingClientRect();["x1","y1","x2","y2"].forEach((c,d)=>{const f=d<2?r:i;o.setAttribute(c,f[c.startsWith("x")?"x":"y"]+f.width/2-s[c.startsWith("x")?"x":"y"])}),this.svgContainer.appendChild(o)})}handleLetterSelection(e){const t=this.selected.length;if(this.selected.includes(e))return e===this.selected[t-1]?(this.potentialUndo=e,this.onSelectionUpdate(this.selected),!0):e===this.selected[t-2]?(document.getElementById(`mark-${this.selected[t-1]}`).classList.remove("selected"),this.selected.pop(),this.drawLine(),this.onSelectionUpdate(this.selected),!0):!1;if(this.potentialUndo=null,!t||this.areAdjacent(this.selected[t-1],e)){const o=document.getElementById(`mark-${e}`);return this.selected.push(e),o.classList.add("selected"),this.drawLine(),this.onSelectionUpdate(this.selected),!0}return this.isDragging?!1:(this.reset(),document.getElementById(`mark-${e}`).classList.add("selected"),this.selected.push(e),this.onSelectionUpdate(this.selected),!0)}areAdjacent(e,t){if(e===t)return!1;const[o,r]=[e.charCodeAt(0)-97,parseInt(e[1])-1],[i,s]=[t.charCodeAt(0)-97,parseInt(t[1])-1];return Math.abs(o-i)<=1&&Math.abs(r-s)<=1}handlePointerDown(e){var r;const t=!!((r=e==null?void 0:e.target)!=null&&r.closest(".board"));if(this.startedInsideBoard=t,!t)return;const o=this.getHitboxFromEvent(e);if(!o){this.isDragging||this.reset();return}e.preventDefault(),this._isPointerDown=!0,this._isDragging=!1,this.handleLetterSelection(o.dataset.position)}handlePointerMove(e){var r;if(!this._isPointerDown||!((r=e.target)!=null&&r.closest(".board"))||(e.preventDefault(),!this.startedInsideBoard&&!this._isDragging))return;const t=this.getHitboxFromEvent(e);if(!t)return;const o=t.dataset.position;this.selected[this.selected.length-1]!==o&&(this._isDragging=!0,this.handleLetterSelection(o))}handlePointerUp(e){var t;if(!this._isDragging&&this.potentialUndo){const o=this.getHitboxFromEvent(e);o&&this.potentialUndo===o.dataset.position&&(document.getElementById(`mark-${this.potentialUndo}`).classList.remove("selected"),this.selected.pop(),this.drawLine())}(t=e==null?void 0:e.target)!=null&&t.closest(".board")?(this._isPointerDown=!1,this._isDragging=!1):(this.resetControls(),this.reset())}handlePointerOut(){return this._isPointerDown=!1,this._isDragging||this.selected.length>0}handlePointerEnter(e){e.buttons>0&&(this.startedInsideBoard||this.selected.length>0)&&(this._isPointerDown=!0)}getHitboxFromEvent(e){var t,o,r;if(!e)return null;if(e.touches||e.changedTouches){const i=((t=e.touches)==null?void 0:t[0])||((o=e.changedTouches)==null?void 0:o[0]);if(!i)return null;const s=document.elementFromPoint(i.clientX,i.clientY);return s==null?void 0:s.closest(".hitbox")}return(r=e.target)==null?void 0:r.closest(".hitbox")}isPlayableArea(e){return e!=null&&e.target?e.target.closest(".hitbox")||e.target.closest(".board"):!1}get isDragging(){return this._isDragging}get isPointerDown(){return this._isPointerDown}handleTouchMove(e){e.preventDefault(),this.handlePointerMove(e)}getWasSelecting(){return this._wasSelecting}setWasSelecting(e){this._wasSelecting=e}}var Le={};(function l(e,t,o,r){var i=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),s=typeof Path2D=="function"&&typeof DOMMatrix=="function",c=function(){if(!e.OffscreenCanvas)return!1;var n=new OffscreenCanvas(1,1),a=n.getContext("2d");a.fillRect(0,0,1,1);var m=n.transferToImageBitmap();try{a.createPattern(m,"no-repeat")}catch{return!1}return!0}();function d(){}function f(n){var a=t.exports.Promise,m=a!==void 0?a:e.Promise;return typeof m=="function"?new m(n):(n(d,d),null)}var k=function(n,a){return{transform:function(m){if(n)return m;if(a.has(m))return a.get(m);var u=new OffscreenCanvas(m.width,m.height),p=u.getContext("2d");return p.drawImage(m,0,0),a.set(m,u),u},clear:function(){a.clear()}}}(c,new Map),h=function(){var n=Math.floor(16.666666666666668),a,m,u={},p=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(a=function(b){var y=Math.random();return u[y]=requestAnimationFrame(function g(w){p===w||p+n-1<w?(p=w,delete u[y],b()):u[y]=requestAnimationFrame(g)}),y},m=function(b){u[b]&&cancelAnimationFrame(u[b])}):(a=function(b){return setTimeout(b,n)},m=function(b){return clearTimeout(b)}),{frame:a,cancel:m}}(),x=function(){var n,a,m={};function u(p){function b(y,g){p.postMessage({options:y||{},callback:g})}p.init=function(g){var w=g.transferControlToOffscreen();p.postMessage({canvas:w},[w])},p.fire=function(g,w,C){if(a)return b(g,null),a;var I=Math.random().toString(36).slice(2);return a=f(function(P){function F(_){_.data.callback===I&&(delete m[I],p.removeEventListener("message",F),a=null,k.clear(),C(),P())}p.addEventListener("message",F),b(g,I),m[I]=F.bind(null,{data:{callback:I}})}),a},p.reset=function(){p.postMessage({reset:!0});for(var g in m)m[g](),delete m[g]}}return function(){if(n)return n;if(!o&&i){var p=["var CONFETTI, SIZE = {}, module = {};","("+l.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{n=new Worker(URL.createObjectURL(new Blob([p])))}catch(b){return typeof console!==void 0&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",b),null}u(n)}return n}}(),L={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function T(n,a){return a?a(n):n}function O(n){return n!=null}function v(n,a,m){return T(n&&O(n[a])?n[a]:L[a],m)}function A(n){return n<0?0:Math.floor(n)}function U(n,a){return Math.floor(Math.random()*(a-n))+n}function N(n){return parseInt(n,16)}function q(n){return n.map(K)}function K(n){var a=String(n).replace(/[^0-9a-f]/gi,"");return a.length<6&&(a=a[0]+a[0]+a[1]+a[1]+a[2]+a[2]),{r:N(a.substring(0,2)),g:N(a.substring(2,4)),b:N(a.substring(4,6))}}function j(n){var a=v(n,"origin",Object);return a.x=v(a,"x",Number),a.y=v(a,"y",Number),a}function V(n){n.width=document.documentElement.clientWidth,n.height=document.documentElement.clientHeight}function M(n){var a=n.getBoundingClientRect();n.width=a.width,n.height=a.height}function z(n){var a=document.createElement("canvas");return a.style.position="fixed",a.style.top="0px",a.style.left="0px",a.style.pointerEvents="none",a.style.zIndex=n,a}function W(n,a,m,u,p,b,y,g,w){n.save(),n.translate(a,m),n.rotate(b),n.scale(u,p),n.arc(0,0,1,y,g,w),n.restore()}function J(n){var a=n.angle*(Math.PI/180),m=n.spread*(Math.PI/180);return{x:n.x,y:n.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:n.startVelocity*.5+Math.random()*n.startVelocity,angle2D:-a+(.5*m-Math.random()*m),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:n.color,shape:n.shape,tick:0,totalTicks:n.ticks,decay:n.decay,drift:n.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:n.gravity*3,ovalScalar:.6,scalar:n.scalar,flat:n.flat}}function ee(n,a){a.x+=Math.cos(a.angle2D)*a.velocity+a.drift,a.y+=Math.sin(a.angle2D)*a.velocity+a.gravity,a.velocity*=a.decay,a.flat?(a.wobble=0,a.wobbleX=a.x+10*a.scalar,a.wobbleY=a.y+10*a.scalar,a.tiltSin=0,a.tiltCos=0,a.random=1):(a.wobble+=a.wobbleSpeed,a.wobbleX=a.x+10*a.scalar*Math.cos(a.wobble),a.wobbleY=a.y+10*a.scalar*Math.sin(a.wobble),a.tiltAngle+=.1,a.tiltSin=Math.sin(a.tiltAngle),a.tiltCos=Math.cos(a.tiltAngle),a.random=Math.random()+2);var m=a.tick++/a.totalTicks,u=a.x+a.random*a.tiltCos,p=a.y+a.random*a.tiltSin,b=a.wobbleX+a.random*a.tiltCos,y=a.wobbleY+a.random*a.tiltSin;if(n.fillStyle="rgba("+a.color.r+", "+a.color.g+", "+a.color.b+", "+(1-m)+")",n.beginPath(),s&&a.shape.type==="path"&&typeof a.shape.path=="string"&&Array.isArray(a.shape.matrix))n.fill($e(a.shape.path,a.shape.matrix,a.x,a.y,Math.abs(b-u)*.1,Math.abs(y-p)*.1,Math.PI/10*a.wobble));else if(a.shape.type==="bitmap"){var g=Math.PI/10*a.wobble,w=Math.abs(b-u)*.1,C=Math.abs(y-p)*.1,I=a.shape.bitmap.width*a.scalar,P=a.shape.bitmap.height*a.scalar,F=new DOMMatrix([Math.cos(g)*w,Math.sin(g)*w,-Math.sin(g)*C,Math.cos(g)*C,a.x,a.y]);F.multiplySelf(new DOMMatrix(a.shape.matrix));var _=n.createPattern(k.transform(a.shape.bitmap),"no-repeat");_.setTransform(F),n.globalAlpha=1-m,n.fillStyle=_,n.fillRect(a.x-I/2,a.y-P/2,I,P),n.globalAlpha=1}else if(a.shape==="circle")n.ellipse?n.ellipse(a.x,a.y,Math.abs(b-u)*a.ovalScalar,Math.abs(y-p)*a.ovalScalar,Math.PI/10*a.wobble,0,2*Math.PI):W(n,a.x,a.y,Math.abs(b-u)*a.ovalScalar,Math.abs(y-p)*a.ovalScalar,Math.PI/10*a.wobble,0,2*Math.PI);else if(a.shape==="star")for(var E=Math.PI/2*3,Y=4*a.scalar,X=8*a.scalar,Z=a.x,re=a.y,le=5,te=Math.PI/le;le--;)Z=a.x+Math.cos(E)*X,re=a.y+Math.sin(E)*X,n.lineTo(Z,re),E+=te,Z=a.x+Math.cos(E)*Y,re=a.y+Math.sin(E)*Y,n.lineTo(Z,re),E+=te;else n.moveTo(Math.floor(a.x),Math.floor(a.y)),n.lineTo(Math.floor(a.wobbleX),Math.floor(p)),n.lineTo(Math.floor(b),Math.floor(y)),n.lineTo(Math.floor(u),Math.floor(a.wobbleY));return n.closePath(),n.fill(),a.tick<a.totalTicks}function H(n,a,m,u,p){var b=a.slice(),y=n.getContext("2d"),g,w,C=f(function(I){function P(){g=w=null,y.clearRect(0,0,u.width,u.height),k.clear(),p(),I()}function F(){o&&!(u.width===r.width&&u.height===r.height)&&(u.width=n.width=r.width,u.height=n.height=r.height),!u.width&&!u.height&&(m(n),u.width=n.width,u.height=n.height),y.clearRect(0,0,u.width,u.height),b=b.filter(function(_){return ee(y,_)}),b.length?g=h.frame(F):P()}g=h.frame(F),w=P});return{addFettis:function(I){return b=b.concat(I),C},canvas:n,promise:C,reset:function(){g&&h.cancel(g),w&&w()}}}function ne(n,a){var m=!n,u=!!v(a||{},"resize"),p=!1,b=v(a,"disableForReducedMotion",Boolean),y=i&&!!v(a||{},"useWorker"),g=y?x():null,w=m?V:M,C=n&&g?!!n.__confetti_initialized:!1,I=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,P;function F(E,Y,X){for(var Z=v(E,"particleCount",A),re=v(E,"angle",Number),le=v(E,"spread",Number),te=v(E,"startVelocity",Number),qe=v(E,"decay",Number),Ye=v(E,"gravity",Number),He=v(E,"drift",Number),Ae=v(E,"colors",q),Ge=v(E,"ticks",Number),ze=v(E,"shapes"),Ke=v(E,"scalar"),Je=!!v(E,"flat"),Ie=j(E),Fe=Z,Se=[],Xe=n.width*Ie.x,Ze=n.height*Ie.y;Fe--;)Se.push(J({x:Xe,y:Ze,angle:re,spread:le,startVelocity:te,color:Ae[Fe%Ae.length],shape:ze[U(0,ze.length)],ticks:Ge,decay:qe,gravity:Ye,drift:He,scalar:Ke,flat:Je}));return P?P.addFettis(Se):(P=H(n,Se,w,Y,X),P.promise)}function _(E){var Y=b||v(E,"disableForReducedMotion",Boolean),X=v(E,"zIndex",Number);if(Y&&I)return f(function(te){te()});m&&P?n=P.canvas:m&&!n&&(n=z(X),document.body.appendChild(n)),u&&!C&&w(n);var Z={width:n.width,height:n.height};g&&!C&&g.init(n),C=!0,g&&(n.__confetti_initialized=!0);function re(){if(g){var te={getBoundingClientRect:function(){if(!m)return n.getBoundingClientRect()}};w(te),g.postMessage({resize:{width:te.width,height:te.height}});return}Z.width=Z.height=null}function le(){P=null,u&&(p=!1,e.removeEventListener("resize",re)),m&&n&&(document.body.contains(n)&&document.body.removeChild(n),n=null,C=!1)}return u&&!p&&(p=!0,e.addEventListener("resize",re,!1)),g?g.fire(E,Z,le):F(E,Z,le)}return _.reset=function(){g&&g.reset(),P&&P.reset()},_}var se;function Me(){return se||(se=ne(null,{useWorker:!0,resize:!0})),se}function $e(n,a,m,u,p,b,y){var g=new Path2D(n),w=new Path2D;w.addPath(g,new DOMMatrix(a));var C=new Path2D;return C.addPath(w,new DOMMatrix([Math.cos(y)*p,Math.sin(y)*p,-Math.sin(y)*b,Math.cos(y)*b,m,u])),C}function Ue(n){if(!s)throw new Error("path confetti are not supported in this browser");var a,m;typeof n=="string"?a=n:(a=n.path,m=n.matrix);var u=new Path2D(a),p=document.createElement("canvas"),b=p.getContext("2d");if(!m){for(var y=1e3,g=y,w=y,C=0,I=0,P,F,_=0;_<y;_+=2)for(var E=0;E<y;E+=2)b.isPointInPath(u,_,E,"nonzero")&&(g=Math.min(g,_),w=Math.min(w,E),C=Math.max(C,_),I=Math.max(I,E));P=C-g,F=I-w;var Y=10,X=Math.min(Y/P,Y/F);m=[X,0,0,X,-Math.round(P/2+g)*X,-Math.round(F/2+w)*X]}return{type:"path",path:a,matrix:m}}function Ve(n){var a,m=1,u="#000000",p='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof n=="string"?a=n:(a=n.text,m="scalar"in n?n.scalar:m,p="fontFamily"in n?n.fontFamily:p,u="color"in n?n.color:u);var b=10*m,y=""+b+"px "+p,g=new OffscreenCanvas(b,b),w=g.getContext("2d");w.font=y;var C=w.measureText(a),I=Math.ceil(C.actualBoundingBoxRight+C.actualBoundingBoxLeft),P=Math.ceil(C.actualBoundingBoxAscent+C.actualBoundingBoxDescent),F=2,_=C.actualBoundingBoxLeft+F,E=C.actualBoundingBoxAscent+F;I+=F+F,P+=F+F,g=new OffscreenCanvas(I,P),w=g.getContext("2d"),w.font=y,w.fillStyle=u,w.fillText(a,_,E);var Y=1/m;return{type:"bitmap",bitmap:g.transferToImageBitmap(),matrix:[Y,0,0,Y,-I*Y/2,-P*Y/2]}}t.exports=function(){return Me().apply(this,arguments)},t.exports.reset=function(){Me().reset()},t.exports.create=ne,t.exports.shapeFromPath=Ue,t.exports.shapeFromText=Ve})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Le,!1);const mt=Le.exports;Le.exports.create;const gt="modulepreload",ut=function(l,e){return new URL(l,e).href},je={},ke=function(e,t,o){let r=Promise.resolve();if(t&&t.length>0){const s=document.getElementsByTagName("link"),c=document.querySelector("meta[property=csp-nonce]"),d=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));r=Promise.allSettled(t.map(f=>{if(f=ut(f,o),f in je)return;je[f]=!0;const k=f.endsWith(".css"),h=k?'[rel="stylesheet"]':"";if(!!o)for(let T=s.length-1;T>=0;T--){const O=s[T];if(O.href===f&&(!k||O.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${f}"]${h}`))return;const L=document.createElement("link");if(L.rel=k?"stylesheet":gt,k||(L.as="script"),L.crossOrigin="",L.href=f,d&&L.setAttribute("nonce",d),document.head.appendChild(L),k)return new Promise((T,O)=>{L.addEventListener("load",T),L.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${f}`)))})}))}function i(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return r.then(s=>{for(const c of s||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},de=pe("Preferences",{web:()=>ke(()=>import("./web.BEYXkSr6.js"),[],import.meta.url).then(l=>new l.PreferencesWeb)});var ye,$;class S{static async initialize(){if(!R(this,ye))try{const e=await this.get(this.KEYS.SETTINGS);e?G(this,$,e):await this.set(this.KEYS.SETTINGS,R(this,$)),G(this,ye,!0),console.log("✅ Storage inicializado:",R(this,$))}catch(e){console.error("❌ Error inicializando Storage:",e)}}static async get(e,t=null){try{const{value:o}=await de.get({key:e});return o?JSON.parse(o):t}catch{try{const r=localStorage.getItem(e);return r?JSON.parse(r):t}catch(r){return console.error(`Error leyendo ${e}:`,r),t}}}static async set(e,t){try{return await de.set({key:e,value:JSON.stringify(t)}),e===this.KEYS.SETTINGS&&G(this,$,t),!0}catch{try{return localStorage.setItem(e,JSON.stringify(t)),e===this.KEYS.SETTINGS&&G(this,$,t),!0}catch(r){return console.error(`Error guardando ${e}:`,r),!1}}}static get isVibrationEnabled(){return R(this,$).vibrationEnabled}static get isNotificationEnabled(){return R(this,$).notificationEnabled}static async setVibrationEnabled(e){return R(this,$).vibrationEnabled=e,this.set(this.KEYS.SETTINGS,R(this,$))}static async setNotificationEnabled(e){return R(this,$).notificationEnabled=e,this.set(this.KEYS.SETTINGS,R(this,$))}static async getCurrentLevel(){return this.get(this.KEYS.CURRENT_LEVEL)}static async setCurrentLevel(e){return this.set(this.KEYS.CURRENT_LEVEL,e)}static async getCurrentTheme(){return this.get(this.KEYS.THEME)}static async setCurrentTheme(e){return this.set(this.KEYS.THEME,e)}static async resetToDefaults(){G(this,$,{vibrationEnabled:!0,notificationEnabled:!0}),await Promise.all([this.set(this.KEYS.SETTINGS,R(this,$)),this.set(this.KEYS.THEME,"dark"),this.set(this.KEYS.CURRENT_LEVEL,Q[0])])}}ye=new WeakMap,$=new WeakMap,be(S,"KEYS",{THEME:"theme",CURRENT_LEVEL:"currentLevel",SETTINGS:"settings"}),me(S,ye,!1),me(S,$,{vibrationEnabled:!0,notificationEnabled:!0});var _e;(function(l){l[l.Sunday=1]="Sunday",l[l.Monday=2]="Monday",l[l.Tuesday=3]="Tuesday",l[l.Wednesday=4]="Wednesday",l[l.Thursday=5]="Thursday",l[l.Friday=6]="Friday",l[l.Saturday=7]="Saturday"})(_e||(_e={}));const ce=pe("LocalNotifications",{web:()=>ke(()=>import("./web.Cm_dTwyM.js"),[],import.meta.url).then(l=>new l.LocalNotificationsWeb)}),we=pe("App",{web:()=>ke(()=>import("./web.BmtTgDyh.js"),[],import.meta.url).then(l=>new l.AppWeb)});var Ee;(function(l){l.Heavy="HEAVY",l.Medium="MEDIUM",l.Light="LIGHT"})(Ee||(Ee={}));var Ce;(function(l){l.Success="SUCCESS",l.Warning="WARNING",l.Error="ERROR"})(Ce||(Ce={}));const ve=pe("Haptics",{web:()=>ke(()=>import("./web.D8FBsNjf.js"),[],import.meta.url).then(l=>new l.HapticsWeb)});var ae,ue,fe;class B{static get isInitialized(){return R(this,ae)}static async initialize(){if(R(this,ae))return console.log("[Capacitor] Ya inicializado"),!0;console.group("[Capacitor] Inicializando servicios");try{return console.log("[Capacitor] Detectando plataforma..."),console.log("[Capacitor] Estado:",{platform:D.platform,isNative:D.isNative,getPlatform:D.getPlatform()}),D.isNative?(console.log("[Capacitor] Configurando servicios nativos"),await this.setupNativeServices(),G(this,ae,!0),console.log("[Capacitor] ✅ Servicios nativos listos"),console.groupEnd(),!0):(console.log("[Capacitor] Usando web fallbacks"),await this.setupWebServices(),G(this,ae,!0),console.groupEnd(),!0)}catch(e){return console.error("[Capacitor] ❌ Error:",e),console.groupEnd(),G(this,ae,!0),!1}}static async setupWebServices(){console.group("[Capacitor] Configurando servicios web");try{if("serviceWorker"in navigator&&(G(this,fe,await navigator.serviceWorker.register("/sw.js",{scope:"/",type:"classic",updateViaCache:"none",credentials:"same-origin"})),console.log("✅ Service Worker registrado"),await navigator.serviceWorker.ready),"Notification"in window){const e=await Notification.requestPermission();console.log("- Permisos de notificación:",e)}"serviceWorker"in navigator&&console.log("- Service Worker disponible"),"vibrate"in navigator&&console.log("- Vibración disponible"),console.log("✅ Servicios web configurados")}catch(e){console.error("❌ Error configurando servicios web:",e)}console.groupEnd()}static async setupNativeServices(){console.group("[Capacitor] Configurando servicios nativos");const e=[{name:"App",instance:we},{name:"Haptics",instance:ve},{name:"LocalNotifications",instance:ce},{name:"Preferences",instance:de}];for(const{name:t,instance:o}of e)try{const r=D.isPluginAvailable(t);if(console.log(`- ${t}: ${r?"✓":"✗"}`),r&&o&&t==="LocalNotifications"){const i=await o.checkPermissions();console.log(`  Permisos: ${i.display}`)}}catch(r){console.warn(`❌ Error verificando ${t}:`,r)}this.setupAppListeners(),console.log("✅ Configuración nativa completada"),console.groupEnd()}static async setupWebNotifications(){if("Notification"in window){const e=await Notification.requestPermission();console.log("Permisos de notificación web:",e)}}static async setupServiceWorker(){if(!R(this,ae))try{if(this.setupAppListeners(),G(this,ue,D.isNative),console.log("Plataforma nativa:",R(this,ue)),"serviceWorker"in navigator)try{!(window.location.hostname==="localhost"||window.location.hostname.includes("192.168.")||window.location.hostname.includes("127.0.0.1"))||window.location.protocol==="http:"?(G(this,fe,await navigator.serviceWorker.register("/sw.js",{scope:"/",type:"classic",updateViaCache:"none"})),console.log("✅ Service Worker registrado:",R(this,fe))):console.log("Service Worker no registrado en desarrollo local")}catch(e){console.warn("Service Worker no disponible:",e)}G(this,ae,!0),console.log("✅ Servicios nativos inicializados")}catch(e){console.error("❌ Error inicializando servicios nativos:",e)}}static setupAppListeners(){we.addListener("backButton",({canGoBack:e})=>{e||we.exitApp()}),we.addListener("appStateChange",({isActive:e})=>{e?document.dispatchEvent(new Event("appResume")):document.dispatchEvent(new Event("appPause"))})}static async initializeNotifications(){var e;if(console.group("🔔 Inicializando sistema de notificaciones"),R(this,ue))try{console.log("📱 Intentando usar notificaciones nativas...");const{display:t}=await ce.checkPermissions();if(console.log("Estado de permisos nativos:",t),t==="granted"||t==="prompt"){const o=await ce.requestPermissions();if(console.log("Nuevos permisos nativos:",o.display),o.display==="granted"){console.log("✅ Notificaciones nativas activadas"),console.groupEnd();return}}}catch(t){console.warn("❌ Notificaciones nativas no disponibles:",t)}if("Notification"in window)try{let t=Notification.permission;if(t==="default"&&(console.log("📱 Solicitando permisos de notificación..."),t=await Notification.requestPermission()),t==="granted"){(e=R(this,fe))!=null&&e.active?console.log("✅ Service Worker notifications activadas"):console.log("✅ Web Notifications activadas"),console.groupEnd();return}else console.warn("❌ Permisos de notificación denegados:",t)}catch(t){console.warn("❌ Error solicitando permisos:",t)}console.warn("❌ No hay sistema de notificaciones disponible"),console.groupEnd()}static async vibrate(e="MEDIUM"){try{switch(e.toUpperCase()){case"LIGHT":await ve.impact({style:Ee.Light});break;case"HEAVY":await ve.notification({type:Ce.Success});break;case"MEDIUM":default:await ve.impact({style:Ee.Medium})}return!0}catch{return console.warn("Haptics no disponible"),!1}}static getIconPath(){console.group("🖼️ Obteniendo rutas de iconos");const e=D.getPlatform()==="android",o=D.isNative&&e?"ic_notification":"/assets/images/icon.png";return console.log("Icono seleccionado:",o),console.groupEnd(),o}static async sendNotification(e,t){console.group("📱 Enviando notificación");try{const o=this.getIconPath(),r=D.getPlatform()==="android";if(D.isNative&&r){console.log("Usando notificaciones Android nativas");const i=await ce.requestPermissions();if(console.log("Permisos:",i),i.display!=="granted")throw new Error("Permiso denegado en Android");await ce.schedule({notifications:[{title:e,body:t,id:Date.now(),schedule:{at:new Date},autoCancel:!0,smallIcon:o,android:{channelId:"default",importance:4,priority:3,visibility:1,smallIcon:o}}]}),console.log("✅ Notificación Android enviada")}else{if(console.log("Usando notificaciones web"),!("serviceWorker"in navigator))throw new Error("Service Worker no soportado");const i=await navigator.serviceWorker.ready;if(console.log("Service Worker listo"),Notification.permission!=="granted"){const s=await Notification.requestPermission();if(console.log("Permiso de notificación:",s),s!=="granted")throw new Error("Permiso denegado")}await i.showNotification(e,{body:t,icon:o,vibrate:[200,100,200],requireInteraction:!0,actions:[{action:"open",title:"Abrir"}],data:{url:window.location.origin,timestamp:Date.now()}}),console.log("✅ Notificación web enviada")}}catch(o){throw console.error("❌ Error en notificación:",o),o}finally{console.groupEnd()}}static async scheduleNativeNotification(e,t,o){console.group("📱 Programando notificación nativa");try{console.log("Cancelando notificaciones anteriores..."),await ce.cancel({notifications:[{id:1}]});const r=new Date(Date.now()+o*60*60*1e3);return console.log("Tiempo programado:",r),await ce.schedule({notifications:[{title:e,body:t,id:1,schedule:{at:r,allowWhileIdle:!0},actionTypeId:"OPEN_APP"}]}),console.log("✅ Notificación nativa programada"),console.groupEnd(),!0}catch(r){return console.error("❌ Error en notificación nativa:",r),console.groupEnd(),!1}}static isMobile(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"maxTouchPoints"in navigator&&navigator.maxTouchPoints>0}static async scheduleMobileNotification(e,t){console.group("📱 Programando Service Worker notification");try{const o=await navigator.serviceWorker.ready;return console.log("Service Worker listo"),await o.showNotification(e,{body:t,icon:"/assets/images/icon.png",vibrate:[200,100,200]}),console.log("✅ Service Worker notification mostrada"),console.groupEnd(),!0}catch(o){return console.error("❌ Error en Service Worker notification:",o),console.groupEnd(),!1}}static async saveData(e,t){try{return await de.set({key:e,value:JSON.stringify(t)}),!0}catch{return console.warn("Error guardando en Preferences, usando localStorage"),localStorage.setItem(e,JSON.stringify(t)),!1}}static async getData(e,t=null){try{const{value:o}=await de.get({key:e});return o?JSON.parse(o):t}catch{console.warn("Error leyendo de Preferences, usando localStorage");const o=localStorage.getItem(e);return o?JSON.parse(o):t}}static async removeData(e){try{return await de.remove({key:e}),!0}catch{return localStorage.removeItem(e),!1}}static async clearData(){try{return await de.clear(),!0}catch{return localStorage.clear(),!1}}static async logToNative(e,t={}){this._recentLogs||(this._recentLogs=new Set);const o=`${e}-${JSON.stringify(t)}`;this._recentLogs.has(o)||(this._recentLogs.add(o),setTimeout(()=>this._recentLogs.delete(o),1e3),D.getPlatform()==="android"?console.debug(`[GameSalad] ${e}`,JSON.stringify(t,null,2)):console.log(e,t))}}ae=new WeakMap,ue=new WeakMap,fe=new WeakMap,me(B,ae,!1),me(B,ue,!1),me(B,fe,null);class oe{static async measureText(e,t){const o=document.createElement("div");o.style.cssText=`
            position: absolute;
            visibility: hidden;
            white-space: pre;
            ${Object.entries(t).map(([i,s])=>`${i}:${s}`).join(";")}
        `,o.textContent=e,document.body.appendChild(o);const r={width:o.offsetWidth,height:o.offsetHeight,left:o.offsetLeft,top:o.offsetTop};return document.body.removeChild(o),r}static animateWordFound(e,t,o){return new Promise(r=>{const i=document.getElementById(`tile-${e[e.length-1]}`),s=i.querySelector(".text"),c=t.querySelector("span");c.style.opacity="0";const d=window.getComputedStyle(c),f={source:window.getComputedStyle(s),target:window.getComputedStyle(t)};(async()=>{const k=await Promise.all([...o].map(async A=>this.measureText(A,{"font-size":d.fontSize,"font-family":"var(--font-family-content)","font-weight":f.target.fontWeight,"letter-spacing":f.target.letterSpacing,"text-transform":f.target.textTransform,"font-feature-settings":f.target.fontFeatureSettings}))),h=k.reduce((A,U)=>A+U.width,0),x=c.getBoundingClientRect(),L=i.getBoundingClientRect(),T=(x.width-h)/2,O=[...o].map((A,U)=>{const N=document.createElement("span");N.textContent=A===" "?" ":A,N.className="animated-letter";const q=L.left+L.width/2,K=L.top+L.height/2;N.style.cssText=`
                        position: fixed;
                        left: ${q}px;
                        top: ${K}px;
                        transform: translate(-50%, -50%);
                        opacity: 1;
                    `,document.body.appendChild(N);const j=k.slice(0,U).reduce((z,W)=>z+W.width,0),V=x.left+T+j+k[U].width/2,M=x.top+x.height/2;return{element:N,endX:V,endY:M,startX:q,startY:K,sourceStyles:f.source,targetStyles:f.target}});O.forEach(({element:A,endX:U,endY:N,startX:q,startY:K},j)=>{setTimeout(()=>{A.classList.add("animating"),requestAnimationFrame(()=>{A.classList.add("in-transit");const V=U-q,M=N-K;A.style.cssText+=`
