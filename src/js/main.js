var Qe=Object.defineProperty;var Oe=l=>{throw TypeError(l)};var et=(l,e,t)=>e in l?Qe(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t;var be=(l,e,t)=>et(l,typeof e!="symbol"?e+"":e,t),Ne=(l,e,t)=>e.has(l)||Oe("Cannot "+t);var O=(l,e,t)=>(Ne(l,e,"read from private field"),t?t.call(l):e.get(l)),me=(l,e,t)=>e.has(l)?Oe("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(l):e.set(l,t),G=(l,e,t,o)=>(Ne(l,e,"write to private field"),o?o.call(l,t):e.set(l,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();/*! Capacitor: https://capacitorjs.com/ - MIT License */var he;(function(l){l.Unimplemented="UNIMPLEMENTED",l.Unavailable="UNAVAILABLE"})(he||(he={}));class Te extends Error{constructor(e,t,o){super(e),this.message=e,this.code=t,this.data=o}}const tt=l=>{var e,t;return l!=null&&l.androidBridge?"android":!((t=(e=l==null?void 0:l.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||t===void 0)&&t.bridge?"ios":"web"},ot=l=>{const e=l.CapacitorCustomPlatform||null,t=l.Capacitor||{},o=t.Plugins=t.Plugins||{},r=()=>e!==null?e.name:tt(l),i=()=>r()!=="web",s=g=>{const v=m.get(g);return!!(v!=null&&v.platforms.has(r())||c(g))},c=g=>{var v;return(v=t.PluginHeaders)===null||v===void 0?void 0:v.find(D=>D.name===g)},d=g=>l.console.error(g),m=new Map,S=(g,v={})=>{const D=m.get(g);if(D)return console.warn(`Capacitor plugin "${g}" already registered. Cannot register plugins twice.`),D.proxy;const I=r(),B=c(g);let x;const L=async()=>(!x&&I in v?x=typeof v[I]=="function"?x=await v[I]():x=v[I]:e!==null&&!x&&"web"in v&&(x=typeof v.web=="function"?x=await v.web():x=v.web),x),U=(P,M)=>{var W,J;if(B){const ee=B==null?void 0:B.methods.find(H=>M===H.name);if(ee)return ee.rtype==="promise"?H=>t.nativePromise(g,M.toString(),H):(H,ne)=>t.nativeCallback(g,M.toString(),H,ne);if(P)return(W=P[M])===null||W===void 0?void 0:W.bind(P)}else{if(P)return(J=P[M])===null||J===void 0?void 0:J.bind(P);throw new Te(`"${g}" plugin is not implemented on ${I}`,he.Unimplemented)}},F=P=>{let M;const W=(...J)=>{const ee=L().then(H=>{const ne=U(H,P);if(ne){const se=ne(...J);return M=se==null?void 0:se.remove,se}else throw new Te(`"${g}.${P}()" is not implemented on ${I}`,he.Unimplemented)});return P==="addListener"&&(ee.remove=async()=>M()),ee};return W.toString=()=>`${P.toString()}() { [capacitor code] }`,Object.defineProperty(W,"name",{value:P,writable:!1,configurable:!1}),W},q=F("addListener"),K=F("removeListener"),R=(P,M)=>{const W=q({eventName:P},M),J=async()=>{const H=await W;K({eventName:P,callbackId:H},M)},ee=new Promise(H=>W.then(()=>H({remove:J})));return ee.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await J()},ee},V=new Proxy({},{get(P,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return B?R:q;case"removeListener":return K;default:return F(M)}}});return o[g]=V,m.set(g,{name:g,proxy:V,platforms:new Set([...Object.keys(v),...B?[I]:[]])}),V};return t.convertFileSrc||(t.convertFileSrc=g=>g),t.getPlatform=r,t.handleError=d,t.isNativePlatform=i,t.isPluginAvailable=s,t.registerPlugin=S,t.Exception=Te,t.DEBUG=!!t.DEBUG,t.isLoggingEnabled=!!t.isLoggingEnabled,t},at=l=>l.Capacitor=ot(l),N=at(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),pe=N.registerPlugin;class We{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let o=!1;this.listeners[e]||(this.listeners[e]=[],o=!0),this.listeners[e].push(t);const i=this.windowListeners[e];i&&!i.registered&&this.addWindowListener(i),o&&this.sendRetainedArgumentsForEvent(e);const s=async()=>this.removeListener(e,t);return Promise.resolve({remove:s})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,o){const r=this.listeners[e];if(!r){if(o){let i=this.retainedEventArguments[e];i||(i=[]),i.push(t),this.retainedEventArguments[e]=i}return}r.forEach(i=>i(t))}hasListeners(e){return!!this.listeners[e].length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:o=>{this.notifyListeners(t,o)}}}unimplemented(e="not implemented"){return new N.Exception(e,he.Unimplemented)}unavailable(e="not available"){return new N.Exception(e,he.Unavailable)}async removeListener(e,t){const o=this.listeners[e];if(!o)return;const r=o.indexOf(t);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(o=>{this.notifyListeners(e,o)}))}}const De=l=>encodeURIComponent(l).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Re=l=>l.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class rt extends We{async getCookies(){const e=document.cookie,t={};return e.split(";").forEach(o=>{if(o.length<=0)return;let[r,i]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Re(r).trim(),i=Re(i).trim(),t[r]=i}),t}async setCookie(e){try{const t=De(e.key),o=De(e.value),r=`; expires=${(e.expires||"").replace("expires=","")}`,i=(e.path||"/").replace("path=",""),s=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${t}=${o||""}${r}; path=${i}; ${s};`}catch(t){return Promise.reject(t)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(t){return Promise.reject(t)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const t of e)document.cookie=t.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}pe("CapacitorCookies",{web:()=>new rt});const it=async l=>new Promise((e,t)=>{const o=new FileReader;o.onload=()=>{const r=o.result;e(r.indexOf(",")>=0?r.split(",")[1]:r)},o.onerror=r=>t(r),o.readAsDataURL(l)}),st=(l={})=>{const e=Object.keys(l);return Object.keys(l).map(r=>r.toLocaleLowerCase()).reduce((r,i,s)=>(r[i]=l[e[s]],r),{})},nt=(l,e=!0)=>l?Object.entries(l).reduce((o,r)=>{const[i,s]=r;let c,d;return Array.isArray(s)?(d="",s.forEach(m=>{c=e?encodeURIComponent(m):m,d+=`${i}=${c}&`}),d.slice(0,-1)):(c=e?encodeURIComponent(s):s,d=`${i}=${c}`),`${o}&${d}`},"").substr(1):null,lt=(l,e={})=>{const t=Object.assign({method:l.method||"GET",headers:l.headers},e),r=st(l.headers)["content-type"]||"";if(typeof l.data=="string")t.body=l.data;else if(r.includes("application/x-www-form-urlencoded")){const i=new URLSearchParams;for(const[s,c]of Object.entries(l.data||{}))i.set(s,c);t.body=i.toString()}else if(r.includes("multipart/form-data")||l.data instanceof FormData){const i=new FormData;if(l.data instanceof FormData)l.data.forEach((c,d)=>{i.append(d,c)});else for(const c of Object.keys(l.data))i.append(c,l.data[c]);t.body=i;const s=new Headers(t.headers);s.delete("content-type"),t.headers=s}else(r.includes("application/json")||typeof l.data=="object")&&(t.body=JSON.stringify(l.data));return t};class ct extends We{async request(e){const t=lt(e,e.webFetchExtra),o=nt(e.params,e.shouldEncodeUrlParams),r=o?`${e.url}?${o}`:e.url,i=await fetch(r,t),s=i.headers.get("content-type")||"";let{responseType:c="text"}=i.ok?e:{};s.includes("application/json")&&(c="json");let d,m;switch(c){case"arraybuffer":case"blob":m=await i.blob(),d=await it(m);break;case"json":d=await i.json();break;case"document":case"text":default:d=await i.text()}const S={};return i.headers.forEach((g,v)=>{S[v]=g}),{data:d,headers:S,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}pe("CapacitorHttp",{web:()=>new ct});const dt=[{id:"vg_characters",name:"VG Characters",data:{SONIC:"a1b1c1d1c2","LARA CROFT":"a3b3c4d3c2d2c3b2a2",MARIO:"d4d3c4b4a4"}},{id:"chess",name:"Ajedrez",data:{PAWN:"a1a2a3b3",QUEEN:"d4c4b4a4b3",KING:"c3c2b3b2",KNIGHT:"c3b3c2b2c1d1",BISHOP:"d3c2d2c1b1a1"}},{id:"planets",name:"Planetas",data:{MARS:"c4b3c3b4",MERCURY:"c4d4c3d2c2d1c1",NEPTUNE:"a3a2b1b2c2d3d4",SATURN:"b4b3b2c2c3d3",URANUS:"c2c3b3a3a4b4",VENUS:"a1a2a3a4b4"}}],ie=dt.reduce((l,{id:e,name:t,data:o})=>(l[e]={name:t,data:o},l),{}),Q=Object.keys(ie);class ft{constructor(e,t,o){this.board=e,this.board.querySelectorAll("svg").forEach(r=>r.remove()),this.svgContainer=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgContainer.id="lines",this.board.insertBefore(this.svgContainer,this.board.firstChild),this.onSelectionUpdate=o,this.selected=[],this._isPointerDown=!1,this._isDragging=!1,this.potentialUndo=null,this.startedInsideBoard=!1,this._lastTouchMove=null,this._lastTouchEvent=null,this._wasSelecting=!1}reset(){this.selected.forEach(e=>document.getElementById(`mark-${e}`).classList.remove("selected")),this.svgContainer.innerHTML="",this.selected=[],this.potentialUndo=null}resetControls(){[this._isPointerDown,this._isDragging,this.potentialUndo,this.startedInsideBoard]=[!1,!1,null,!1]}getCurrentSelection(){return[...this.selected]}drawLine(){this.svgContainer.innerHTML="",this.selected.forEach((e,t)=>{if(t===0)return;const o=document.createElementNS("http://www.w3.org/2000/svg","line"),[r,i]=[this.selected[t-1],e].map(c=>document.getElementById(`mark-${c}`).getBoundingClientRect()),s=this.board.getBoundingClientRect();["x1","y1","x2","y2"].forEach((c,d)=>{const m=d<2?r:i;o.setAttribute(c,m[c.startsWith("x")?"x":"y"]+m.width/2-s[c.startsWith("x")?"x":"y"])}),this.svgContainer.appendChild(o)})}handleLetterSelection(e){const t=this.selected.length;if(this.selected.includes(e))return e===this.selected[t-1]?(this.potentialUndo=e,this.onSelectionUpdate(this.selected),!0):e===this.selected[t-2]?(document.getElementById(`mark-${this.selected[t-1]}`).classList.remove("selected"),this.selected.pop(),this.drawLine(),this.onSelectionUpdate(this.selected),!0):!1;if(this.potentialUndo=null,!t||this.areAdjacent(this.selected[t-1],e)){const o=document.getElementById(`mark-${e}`);return this.selected.push(e),o.classList.add("selected"),this.drawLine(),this.onSelectionUpdate(this.selected),!0}return this.isDragging?!1:(this.reset(),document.getElementById(`mark-${e}`).classList.add("selected"),this.selected.push(e),this.onSelectionUpdate(this.selected),!0)}areAdjacent(e,t){if(e===t)return!1;const[o,r]=[e.charCodeAt(0)-97,parseInt(e[1])-1],[i,s]=[t.charCodeAt(0)-97,parseInt(t[1])-1];return Math.abs(o-i)<=1&&Math.abs(r-s)<=1}handlePointerDown(e){var r;const t=!!((r=e==null?void 0:e.target)!=null&&r.closest(".board"));if(this.startedInsideBoard=t,!t)return;const o=this.getHitboxFromEvent(e);if(!o){this.isDragging||this.reset();return}e.preventDefault(),this._isPointerDown=!0,this._isDragging=!1,this.handleLetterSelection(o.dataset.position)}handlePointerMove(e){var r;if(!this._isPointerDown||!((r=e.target)!=null&&r.closest(".board"))||(e.preventDefault(),!this.startedInsideBoard&&!this._isDragging))return;const t=this.getHitboxFromEvent(e);if(!t)return;const o=t.dataset.position;this.selected[this.selected.length-1]!==o&&(this._isDragging=!0,this.handleLetterSelection(o))}handlePointerUp(e){var t;if(!this._isDragging&&this.potentialUndo){const o=this.getHitboxFromEvent(e);o&&this.potentialUndo===o.dataset.position&&(document.getElementById(`mark-${this.potentialUndo}`).classList.remove("selected"),this.selected.pop(),this.drawLine())}(t=e==null?void 0:e.target)!=null&&t.closest(".board")?(this._isPointerDown=!1,this._isDragging=!1):(this.resetControls(),this.reset())}handlePointerOut(){return this._isPointerDown=!1,this._isDragging||this.selected.length>0}handlePointerEnter(e){e.buttons>0&&(this.startedInsideBoard||this.selected.length>0)&&(this._isPointerDown=!0)}getHitboxFromEvent(e){var t,o,r;if(!e)return null;if(e.touches||e.changedTouches){const i=((t=e.touches)==null?void 0:t[0])||((o=e.changedTouches)==null?void 0:o[0]);if(!i)return null;const s=document.elementFromPoint(i.clientX,i.clientY);return s==null?void 0:s.closest(".hitbox")}return(r=e.target)==null?void 0:r.closest(".hitbox")}isPlayableArea(e){return e!=null&&e.target?e.target.closest(".hitbox")||e.target.closest(".board"):!1}get isDragging(){return this._isDragging}get isPointerDown(){return this._isPointerDown}handleTouchMove(e){e.preventDefault(),this.handlePointerMove(e)}getWasSelecting(){return this._wasSelecting}setWasSelecting(e){this._wasSelecting=e}}var Le={};(function l(e,t,o,r){var i=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),s=typeof Path2D=="function"&&typeof DOMMatrix=="function",c=function(){if(!e.OffscreenCanvas)return!1;var n=new OffscreenCanvas(1,1),a=n.getContext("2d");a.fillRect(0,0,1,1);var f=n.transferToImageBitmap();try{a.createPattern(f,"no-repeat")}catch{return!1}return!0}();function d(){}function m(n){var a=t.exports.Promise,f=a!==void 0?a:e.Promise;return typeof f=="function"?new f(n):(n(d,d),null)}var S=function(n,a){return{transform:function(f){if(n)return f;if(a.has(f))return a.get(f);var h=new OffscreenCanvas(f.width,f.height),p=h.getContext("2d");return p.drawImage(f,0,0),a.set(f,h),h},clear:function(){a.clear()}}}(c,new Map),g=function(){var n=Math.floor(16.666666666666668),a,f,h={},p=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(a=function(b){var y=Math.random();return h[y]=requestAnimationFrame(function u(w){p===w||p+n-1<w?(p=w,delete h[y],b()):h[y]=requestAnimationFrame(u)}),y},f=function(b){h[b]&&cancelAnimationFrame(h[b])}):(a=function(b){return setTimeout(b,n)},f=function(b){return clearTimeout(b)}),{frame:a,cancel:f}}(),v=function(){var n,a,f={};function h(p){function b(y,u){p.postMessage({options:y||{},callback:u})}p.init=function(u){var w=u.transferControlToOffscreen();p.postMessage({canvas:w},[w])},p.fire=function(u,w,T){if(a)return b(u,null),a;var A=Math.random().toString(36).slice(2);return a=m(function(C){function z(j){j.data.callback===A&&(delete f[A],p.removeEventListener("message",z),a=null,S.clear(),T(),C())}p.addEventListener("message",z),b(u,A),f[A]=z.bind(null,{data:{callback:A}})}),a},p.reset=function(){p.postMessage({reset:!0});for(var u in f)f[u](),delete f[u]}}return function(){if(n)return n;if(!o&&i){var p=["var CONFETTI, SIZE = {}, module = {};","("+l.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{n=new Worker(URL.createObjectURL(new Blob([p])))}catch(b){return typeof console!==void 0&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",b),null}h(n)}return n}}(),D={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function I(n,a){return a?a(n):n}function B(n){return n!=null}function x(n,a,f){return I(n&&B(n[a])?n[a]:D[a],f)}function L(n){return n<0?0:Math.floor(n)}function U(n,a){return Math.floor(Math.random()*(a-n))+n}function F(n){return parseInt(n,16)}function q(n){return n.map(K)}function K(n){var a=String(n).replace(/[^0-9a-f]/gi,"");return a.length<6&&(a=a[0]+a[0]+a[1]+a[1]+a[2]+a[2]),{r:F(a.substring(0,2)),g:F(a.substring(2,4)),b:F(a.substring(4,6))}}function R(n){var a=x(n,"origin",Object);return a.x=x(a,"x",Number),a.y=x(a,"y",Number),a}function V(n){n.width=document.documentElement.clientWidth,n.height=document.documentElement.clientHeight}function P(n){var a=n.getBoundingClientRect();n.width=a.width,n.height=a.height}function M(n){var a=document.createElement("canvas");return a.style.position="fixed",a.style.top="0px",a.style.left="0px",a.style.pointerEvents="none",a.style.zIndex=n,a}function W(n,a,f,h,p,b,y,u,w){n.save(),n.translate(a,f),n.rotate(b),n.scale(h,p),n.arc(0,0,1,y,u,w),n.restore()}function J(n){var a=n.angle*(Math.PI/180),f=n.spread*(Math.PI/180);return{x:n.x,y:n.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:n.startVelocity*.5+Math.random()*n.startVelocity,angle2D:-a+(.5*f-Math.random()*f),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:n.color,shape:n.shape,tick:0,totalTicks:n.ticks,decay:n.decay,drift:n.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:n.gravity*3,ovalScalar:.6,scalar:n.scalar,flat:n.flat}}function ee(n,a){a.x+=Math.cos(a.angle2D)*a.velocity+a.drift,a.y+=Math.sin(a.angle2D)*a.velocity+a.gravity,a.velocity*=a.decay,a.flat?(a.wobble=0,a.wobbleX=a.x+10*a.scalar,a.wobbleY=a.y+10*a.scalar,a.tiltSin=0,a.tiltCos=0,a.random=1):(a.wobble+=a.wobbleSpeed,a.wobbleX=a.x+10*a.scalar*Math.cos(a.wobble),a.wobbleY=a.y+10*a.scalar*Math.sin(a.wobble),a.tiltAngle+=.1,a.tiltSin=Math.sin(a.tiltAngle),a.tiltCos=Math.cos(a.tiltAngle),a.random=Math.random()+2);var f=a.tick++/a.totalTicks,h=a.x+a.random*a.tiltCos,p=a.y+a.random*a.tiltSin,b=a.wobbleX+a.random*a.tiltCos,y=a.wobbleY+a.random*a.tiltSin;if(n.fillStyle="rgba("+a.color.r+", "+a.color.g+", "+a.color.b+", "+(1-f)+")",n.beginPath(),s&&a.shape.type==="path"&&typeof a.shape.path=="string"&&Array.isArray(a.shape.matrix))n.fill($e(a.shape.path,a.shape.matrix,a.x,a.y,Math.abs(b-h)*.1,Math.abs(y-p)*.1,Math.PI/10*a.wobble));else if(a.shape.type==="bitmap"){var u=Math.PI/10*a.wobble,w=Math.abs(b-h)*.1,T=Math.abs(y-p)*.1,A=a.shape.bitmap.width*a.scalar,C=a.shape.bitmap.height*a.scalar,z=new DOMMatrix([Math.cos(u)*w,Math.sin(u)*w,-Math.sin(u)*T,Math.cos(u)*T,a.x,a.y]);z.multiplySelf(new DOMMatrix(a.shape.matrix));var j=n.createPattern(S.transform(a.shape.bitmap),"no-repeat");j.setTransform(z),n.globalAlpha=1-f,n.fillStyle=j,n.fillRect(a.x-A/2,a.y-C/2,A,C),n.globalAlpha=1}else if(a.shape==="circle")n.ellipse?n.ellipse(a.x,a.y,Math.abs(b-h)*a.ovalScalar,Math.abs(y-p)*a.ovalScalar,Math.PI/10*a.wobble,0,2*Math.PI):W(n,a.x,a.y,Math.abs(b-h)*a.ovalScalar,Math.abs(y-p)*a.ovalScalar,Math.PI/10*a.wobble,0,2*Math.PI);else if(a.shape==="star")for(var E=Math.PI/2*3,Y=4*a.scalar,X=8*a.scalar,Z=a.x,re=a.y,le=5,te=Math.PI/le;le--;)Z=a.x+Math.cos(E)*X,re=a.y+Math.sin(E)*X,n.lineTo(Z,re),E+=te,Z=a.x+Math.cos(E)*Y,re=a.y+Math.sin(E)*Y,n.lineTo(Z,re),E+=te;else n.moveTo(Math.floor(a.x),Math.floor(a.y)),n.lineTo(Math.floor(a.wobbleX),Math.floor(p)),n.lineTo(Math.floor(b),Math.floor(y)),n.lineTo(Math.floor(h),Math.floor(a.wobbleY));return n.closePath(),n.fill(),a.tick<a.totalTicks}function H(n,a,f,h,p){var b=a.slice(),y=n.getContext("2d"),u,w,T=m(function(A){function C(){u=w=null,y.clearRect(0,0,h.width,h.height),S.clear(),p(),A()}function z(){o&&!(h.width===r.width&&h.height===r.height)&&(h.width=n.width=r.width,h.height=n.height=r.height),!h.width&&!h.height&&(f(n),h.width=n.width,h.height=n.height),y.clearRect(0,0,h.width,h.height),b=b.filter(function(j){return ee(y,j)}),b.length?u=g.frame(z):C()}u=g.frame(z),w=C});return{addFettis:function(A){return b=b.concat(A),T},canvas:n,promise:T,reset:function(){u&&g.cancel(u),w&&w()}}}function ne(n,a){var f=!n,h=!!x(a||{},"resize"),p=!1,b=x(a,"disableForReducedMotion",Boolean),y=i&&!!x(a||{},"useWorker"),u=y?v():null,w=f?V:P,T=n&&u?!!n.__confetti_initialized:!1,A=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,C;function z(E,Y,X){for(var Z=x(E,"particleCount",L),re=x(E,"angle",Number),le=x(E,"spread",Number),te=x(E,"startVelocity",Number),qe=x(E,"decay",Number),Ye=x(E,"gravity",Number),He=x(E,"drift",Number),Ae=x(E,"colors",q),Ge=x(E,"ticks",Number),ze=x(E,"shapes"),Ke=x(E,"scalar"),Je=!!x(E,"flat"),Ie=R(E),Fe=Z,Se=[],Xe=n.width*Ie.x,Ze=n.height*Ie.y;Fe--;)Se.push(J({x:Xe,y:Ze,angle:re,spread:le,startVelocity:te,color:Ae[Fe%Ae.length],shape:ze[U(0,ze.length)],ticks:Ge,decay:qe,gravity:Ye,drift:He,scalar:Ke,flat:Je}));return C?C.addFettis(Se):(C=H(n,Se,w,Y,X),C.promise)}function j(E){var Y=b||x(E,"disableForReducedMotion",Boolean),X=x(E,"zIndex",Number);if(Y&&A)return m(function(te){te()});f&&C?n=C.canvas:f&&!n&&(n=M(X),document.body.appendChild(n)),h&&!T&&w(n);var Z={width:n.width,height:n.height};u&&!T&&u.init(n),T=!0,u&&(n.__confetti_initialized=!0);function re(){if(u){var te={getBoundingClientRect:function(){if(!f)return n.getBoundingClientRect()}};w(te),u.postMessage({resize:{width:te.width,height:te.height}});return}Z.width=Z.height=null}function le(){C=null,h&&(p=!1,e.removeEventListener("resize",re)),f&&n&&(document.body.contains(n)&&document.body.removeChild(n),n=null,T=!1)}return h&&!p&&(p=!0,e.addEventListener("resize",re,!1)),u?u.fire(E,Z,le):z(E,Z,le)}return j.reset=function(){u&&u.reset(),C&&C.reset()},j}var se;function Me(){return se||(se=ne(null,{useWorker:!0,resize:!0})),se}function $e(n,a,f,h,p,b,y){var u=new Path2D(n),w=new Path2D;w.addPath(u,new DOMMatrix(a));var T=new Path2D;return T.addPath(w,new DOMMatrix([Math.cos(y)*p,Math.sin(y)*p,-Math.sin(y)*b,Math.cos(y)*b,f,h])),T}function Ue(n){if(!s)throw new Error("path confetti are not supported in this browser");var a,f;typeof n=="string"?a=n:(a=n.path,f=n.matrix);var h=new Path2D(a),p=document.createElement("canvas"),b=p.getContext("2d");if(!f){for(var y=1e3,u=y,w=y,T=0,A=0,C,z,j=0;j<y;j+=2)for(var E=0;E<y;E+=2)b.isPointInPath(h,j,E,"nonzero")&&(u=Math.min(u,j),w=Math.min(w,E),T=Math.max(T,j),A=Math.max(A,E));C=T-u,z=A-w;var Y=10,X=Math.min(Y/C,Y/z);f=[X,0,0,X,-Math.round(C/2+u)*X,-Math.round(z/2+w)*X]}return{type:"path",path:a,matrix:f}}function Ve(n){var a,f=1,h="#000000",p='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof n=="string"?a=n:(a=n.text,f="scalar"in n?n.scalar:f,p="fontFamily"in n?n.fontFamily:p,h="color"in n?n.color:h);var b=10*f,y=""+b+"px "+p,u=new OffscreenCanvas(b,b),w=u.getContext("2d");w.font=y;var T=w.measureText(a),A=Math.ceil(T.actualBoundingBoxRight+T.actualBoundingBoxLeft),C=Math.ceil(T.actualBoundingBoxAscent+T.actualBoundingBoxDescent),z=2,j=T.actualBoundingBoxLeft+z,E=T.actualBoundingBoxAscent+z;A+=z+z,C+=z+z,u=new OffscreenCanvas(A,C),w=u.getContext("2d"),w.font=y,w.fillStyle=h,w.fillText(a,j,E);var Y=1/f;return{type:"bitmap",bitmap:u.transferToImageBitmap(),matrix:[Y,0,0,Y,-A*Y/2,-C*Y/2]}}t.exports=function(){return Me().apply(this,arguments)},t.exports.reset=function(){Me().reset()},t.exports.create=ne,t.exports.shapeFromPath=Ue,t.exports.shapeFromText=Ve})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Le,!1);const mt=Le.exports;Le.exports.create;const gt="modulepreload",ut=function(l){return"/"+l},je={},ke=function(e,t,o){let r=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));r=Promise.allSettled(t.map(d=>{if(d=ut(d),d in je)return;je[d]=!0;const m=d.endsWith(".css"),S=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${S}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":gt,m||(g.as="script"),g.crossOrigin="",g.href=d,c&&g.setAttribute("nonce",c),document.head.appendChild(g),m)return new Promise((v,D)=>{g.addEventListener("load",v),g.addEventListener("error",()=>D(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return r.then(s=>{for(const c of s||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},de=pe("Preferences",{web:()=>ke(()=>import("./web-DiSoNpLB.js"),[]).then(l=>new l.PreferencesWeb)});var ye,$;class k{static async initialize(){if(!O(this,ye))try{const e=await this.get(this.KEYS.SETTINGS);e?G(this,$,e):await this.set(this.KEYS.SETTINGS,O(this,$)),G(this,ye,!0),console.log("✅ Storage inicializado:",O(this,$))}catch(e){console.error("❌ Error inicializando Storage:",e)}}static async get(e,t=null){try{const{value:o}=await de.get({key:e});return o?JSON.parse(o):t}catch{try{const r=localStorage.getItem(e);return r?JSON.parse(r):t}catch(r){return console.error(`Error leyendo ${e}:`,r),t}}}static async set(e,t){try{return await de.set({key:e,value:JSON.stringify(t)}),e===this.KEYS.SETTINGS&&G(this,$,t),!0}catch{try{return localStorage.setItem(e,JSON.stringify(t)),e===this.KEYS.SETTINGS&&G(this,$,t),!0}catch(r){return console.error(`Error guardando ${e}:`,r),!1}}}static get isVibrationEnabled(){return O(this,$).vibrationEnabled}static get isNotificationEnabled(){return O(this,$).notificationEnabled}static async setVibrationEnabled(e){return O(this,$).vibrationEnabled=e,this.set(this.KEYS.SETTINGS,O(this,$))}static async setNotificationEnabled(e){return O(this,$).notificationEnabled=e,this.set(this.KEYS.SETTINGS,O(this,$))}static async getCurrentLevel(){return this.get(this.KEYS.CURRENT_LEVEL)}static async setCurrentLevel(e){return this.set(this.KEYS.CURRENT_LEVEL,e)}static async getCurrentTheme(){return this.get(this.KEYS.THEME)}static async setCurrentTheme(e){return this.set(this.KEYS.THEME,e)}static async resetToDefaults(){G(this,$,{vibrationEnabled:!0,notificationEnabled:!0}),await Promise.all([this.set(this.KEYS.SETTINGS,O(this,$)),this.set(this.KEYS.THEME,"dark"),this.set(this.KEYS.CURRENT_LEVEL,Q[0])])}}ye=new WeakMap,$=new WeakMap,be(k,"KEYS",{THEME:"theme",CURRENT_LEVEL:"currentLevel",SETTINGS:"settings"}),me(k,ye,!1),me(k,$,{vibrationEnabled:!0,notificationEnabled:!0});var _e;(function(l){l[l.Sunday=1]="Sunday",l[l.Monday=2]="Monday",l[l.Tuesday=3]="Tuesday",l[l.Wednesday=4]="Wednesday",l[l.Thursday=5]="Thursday",l[l.Friday=6]="Friday",l[l.Saturday=7]="Saturday"})(_e||(_e={}));const ce=pe("LocalNotifications",{web:()=>ke(()=>import("./web-B4BGIex0.js"),[]).then(l=>new l.LocalNotificationsWeb)}),we=pe("App",{web:()=>ke(()=>import("./web-0urCVRTF.js"),[]).then(l=>new l.AppWeb)});var Ee;(function(l){l.Heavy="HEAVY",l.Medium="MEDIUM",l.Light="LIGHT"})(Ee||(Ee={}));var Ce;(function(l){l.Success="SUCCESS",l.Warning="WARNING",l.Error="ERROR"})(Ce||(Ce={}));const ve=pe("Haptics",{web:()=>ke(()=>import("./web-CYgRyw0C.js"),[]).then(l=>new l.HapticsWeb)});var ae,ue,fe;class _{static get isInitialized(){return O(this,ae)}static async initialize(){if(O(this,ae))return console.log("[Capacitor] Ya inicializado"),!0;console.group("[Capacitor] Inicializando servicios");try{return console.log("[Capacitor] Detectando plataforma..."),console.log("[Capacitor] Estado:",{platform:N.platform,isNative:N.isNative,getPlatform:N.getPlatform()}),N.isNative?(console.log("[Capacitor] Configurando servicios nativos"),await this.setupNativeServices(),G(this,ae,!0),console.log("[Capacitor] ✅ Servicios nativos listos"),console.groupEnd(),!0):(console.log("[Capacitor] Usando web fallbacks"),await this.setupWebServices(),G(this,ae,!0),console.groupEnd(),!0)}catch(e){return console.error("[Capacitor] ❌ Error:",e),console.groupEnd(),G(this,ae,!0),!1}}static async setupWebServices(){console.group("[Capacitor] Configurando servicios web");try{if("serviceWorker"in navigator&&(G(this,fe,await navigator.serviceWorker.register("/sw.js",{scope:"/",type:"classic",updateViaCache:"none",credentials:"same-origin"})),console.log("✅ Service Worker registrado"),await navigator.serviceWorker.ready),"Notification"in window){const e=await Notification.requestPermission();console.log("- Permisos de notificación:",e)}"serviceWorker"in navigator&&console.log("- Service Worker disponible"),"vibrate"in navigator&&console.log("- Vibración disponible"),console.log("✅ Servicios web configurados")}catch(e){console.error("❌ Error configurando servicios web:",e)}console.groupEnd()}static async setupNativeServices(){console.group("[Capacitor] Configurando servicios nativos");const e=[{name:"App",instance:we},{name:"Haptics",instance:ve},{name:"LocalNotifications",instance:ce},{name:"Preferences",instance:de}];for(const{name:t,instance:o}of e)try{const r=N.isPluginAvailable(t);if(console.log(`- ${t}: ${r?"✓":"✗"}`),r&&o&&t==="LocalNotifications"){const i=await o.checkPermissions();console.log(`  Permisos: ${i.display}`)}}catch(r){console.warn(`❌ Error verificando ${t}:`,r)}this.setupAppListeners(),console.log("✅ Configuración nativa completada"),console.groupEnd()}static async setupWebNotifications(){if("Notification"in window){const e=await Notification.requestPermission();console.log("Permisos de notificación web:",e)}}static async setupServiceWorker(){if(!O(this,ae))try{if(this.setupAppListeners(),G(this,ue,N.isNative),console.log("Plataforma nativa:",O(this,ue)),"serviceWorker"in navigator)try{!(window.location.hostname==="localhost"||window.location.hostname.includes("192.168.")||window.location.hostname.includes("127.0.0.1"))||window.location.protocol==="http:"?(G(this,fe,await navigator.serviceWorker.register("/sw.js",{scope:"/",type:"classic",updateViaCache:"none"})),console.log("✅ Service Worker registrado:",O(this,fe))):console.log("Service Worker no registrado en desarrollo local")}catch(e){console.warn("Service Worker no disponible:",e)}G(this,ae,!0),console.log("✅ Servicios nativos inicializados")}catch(e){console.error("❌ Error inicializando servicios nativos:",e)}}static setupAppListeners(){we.addListener("backButton",({canGoBack:e})=>{e||we.exitApp()}),we.addListener("appStateChange",({isActive:e})=>{e?document.dispatchEvent(new Event("appResume")):document.dispatchEvent(new Event("appPause"))})}static async initializeNotifications(){var e;if(console.group("🔔 Inicializando sistema de notificaciones"),O(this,ue))try{console.log("📱 Intentando usar notificaciones nativas...");const{display:t}=await ce.checkPermissions();if(console.log("Estado de permisos nativos:",t),t==="granted"||t==="prompt"){const o=await ce.requestPermissions();if(console.log("Nuevos permisos nativos:",o.display),o.display==="granted"){console.log("✅ Notificaciones nativas activadas"),console.groupEnd();return}}}catch(t){console.warn("❌ Notificaciones nativas no disponibles:",t)}if("Notification"in window)try{let t=Notification.permission;if(t==="default"&&(console.log("📱 Solicitando permisos de notificación..."),t=await Notification.requestPermission()),t==="granted"){(e=O(this,fe))!=null&&e.active?console.log("✅ Service Worker notifications activadas"):console.log("✅ Web Notifications activadas"),console.groupEnd();return}else console.warn("❌ Permisos de notificación denegados:",t)}catch(t){console.warn("❌ Error solicitando permisos:",t)}console.warn("❌ No hay sistema de notificaciones disponible"),console.groupEnd()}static async vibrate(e="MEDIUM"){try{switch(e.toUpperCase()){case"LIGHT":await ve.impact({style:Ee.Light});break;case"HEAVY":await ve.notification({type:Ce.Success});break;case"MEDIUM":default:await ve.impact({style:Ee.Medium})}return!0}catch{return console.warn("Haptics no disponible"),!1}}static getIconPath(){console.group("🖼️ Obteniendo rutas de iconos");const e=N.getPlatform()==="android",o=N.isNative&&e?"ic_notification":"/assets/images/icon.png";return console.log("Icono seleccionado:",o),console.groupEnd(),o}static async sendNotification(e,t){console.group("📱 Enviando notificación");try{const o=this.getIconPath(),r=N.getPlatform()==="android";if(N.isNative&&r){console.log("Usando notificaciones Android nativas");const i=await ce.requestPermissions();if(console.log("Permisos:",i),i.display!=="granted")throw new Error("Permiso denegado en Android");await ce.schedule({notifications:[{title:e,body:t,id:Date.now(),schedule:{at:new Date},autoCancel:!0,smallIcon:o,android:{channelId:"default",importance:4,priority:3,visibility:1,smallIcon:o}}]}),console.log("✅ Notificación Android enviada")}else{if(console.log("Usando notificaciones web"),!("serviceWorker"in navigator))throw new Error("Service Worker no soportado");const i=await navigator.serviceWorker.ready;if(console.log("Service Worker listo"),Notification.permission!=="granted"){const s=await Notification.requestPermission();if(console.log("Permiso de notificación:",s),s!=="granted")throw new Error("Permiso denegado")}await i.showNotification(e,{body:t,icon:o,vibrate:[200,100,200],requireInteraction:!0,actions:[{action:"open",title:"Abrir"}],data:{url:window.location.origin,timestamp:Date.now()}}),console.log("✅ Notificación web enviada")}}catch(o){throw console.error("❌ Error en notificación:",o),o}finally{console.groupEnd()}}static async scheduleNativeNotification(e,t,o){console.group("📱 Programando notificación nativa");try{console.log("Cancelando notificaciones anteriores..."),await ce.cancel({notifications:[{id:1}]});const r=new Date(Date.now()+o*60*60*1e3);return console.log("Tiempo programado:",r),await ce.schedule({notifications:[{title:e,body:t,id:1,schedule:{at:r,allowWhileIdle:!0},actionTypeId:"OPEN_APP"}]}),console.log("✅ Notificación nativa programada"),console.groupEnd(),!0}catch(r){return console.error("❌ Error en notificación nativa:",r),console.groupEnd(),!1}}static isMobile(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"maxTouchPoints"in navigator&&navigator.maxTouchPoints>0}static async scheduleMobileNotification(e,t){console.group("📱 Programando Service Worker notification");try{const o=await navigator.serviceWorker.ready;return console.log("Service Worker listo"),await o.showNotification(e,{body:t,icon:"/assets/images/icon.png",vibrate:[200,100,200]}),console.log("✅ Service Worker notification mostrada"),console.groupEnd(),!0}catch(o){return console.error("❌ Error en Service Worker notification:",o),console.groupEnd(),!1}}static async saveData(e,t){try{return await de.set({key:e,value:JSON.stringify(t)}),!0}catch{return console.warn("Error guardando en Preferences, usando localStorage"),localStorage.setItem(e,JSON.stringify(t)),!1}}static async getData(e,t=null){try{const{value:o}=await de.get({key:e});return o?JSON.parse(o):t}catch{console.warn("Error leyendo de Preferences, usando localStorage");const o=localStorage.getItem(e);return o?JSON.parse(o):t}}static async removeData(e){try{return await de.remove({key:e}),!0}catch{return localStorage.removeItem(e),!1}}static async clearData(){try{return await de.clear(),!0}catch{return localStorage.clear(),!1}}static async logToNative(e,t={}){this._recentLogs||(this._recentLogs=new Set);const o=`${e}-${JSON.stringify(t)}`;this._recentLogs.has(o)||(this._recentLogs.add(o),setTimeout(()=>this._recentLogs.delete(o),1e3),N.getPlatform()==="android"?console.debug(`[GameSalad] ${e}`,JSON.stringify(t,null,2)):console.log(e,t))}}ae=new WeakMap,ue=new WeakMap,fe=new WeakMap,me(_,ae,!1),me(_,ue,!1),me(_,fe,null);class oe{static async measureText(e,t){const o=document.createElement("div");o.style.cssText=`
            position: absolute;
            visibility: hidden;
            white-space: pre;
            ${Object.entries(t).map(([i,s])=>`${i}:${s}`).join(";")}
        `,o.textContent=e,document.body.appendChild(o);const r={width:o.offsetWidth,height:o.offsetHeight,left:o.offsetLeft,top:o.offsetTop};return document.body.removeChild(o),r}static animateWordFound(e,t,o){return new Promise(r=>{const i=document.getElementById(`tile-${e[e.length-1]}`),s=i.querySelector(".text"),c=t.querySelector("span");c.style.opacity="0";const d=window.getComputedStyle(c),m={source:window.getComputedStyle(s),target:window.getComputedStyle(t)};(async()=>{const S=await Promise.all([...o].map(async L=>this.measureText(L,{"font-size":d.fontSize,"font-family":"var(--font-family-content)","font-weight":m.target.fontWeight,"letter-spacing":m.target.letterSpacing,"text-transform":m.target.textTransform,"font-feature-settings":m.target.fontFeatureSettings}))),g=S.reduce((L,U)=>L+U.width,0),v=c.getBoundingClientRect(),D=i.getBoundingClientRect(),I=(v.width-g)/2,B=[...o].map((L,U)=>{const F=document.createElement("span");F.textContent=L===" "?" ":L,F.className="animated-letter";const q=D.left+D.width/2,K=D.top+D.height/2;F.style.cssText=`
                        position: fixed;
                        left: ${q}px;
                        top: ${K}px;
                        transform: translate(-50%, -50%);
                        opacity: 1;
                    `,document.body.appendChild(F);const R=S.slice(0,U).reduce((M,W)=>M+W.width,0),V=v.left+I+R+S[U].width/2,P=v.top+v.height/2;return{element:F,endX:V,endY:P,startX:q,startY:K,sourceStyles:m.source,targetStyles:m.target}});B.forEach(({element:L,endX:U,endY:F,startX:q,startY:K},R)=>{setTimeout(()=>{L.classList.add("animating"),requestAnimationFrame(()=>{L.classList.add("in-transit");const V=U-q,P=F-K;L.style.cssText+=`
                            ...
                            `;const M=W=>{W.propertyName==="transform"&&(L.removeEventListener("transitionend",M),L.classList.remove("animating","in-transit"),R===B.length-1&&(c.textContent=o,c.style.opacity="1",requestAnimationFrame(()=>{document.querySelectorAll(".animated-letter").forEach(J=>J.remove())})))};L.addEventListener("transitionend",M)})},R*this.DURATIONS.LETTER_DELAY)}),e.forEach(L=>{document.getElementById(`tile-${L}`).classList.add("found-temp")});const x=B.length*this.DURATIONS.LETTER_DELAY+this.DURATIONS.LETTER_ANIMATION;setTimeout(()=>{e.forEach(L=>{document.getElementById(`tile-${L}`).classList.remove("found-temp")}),r(x)},x)})()})}static async animateUnusedCells(e){e.forEach(t=>{const o=document.getElementById(`tile-${t}`);requestAnimationFrame(()=>o.classList.add("unused"))})}static async animateVictory(e){document.getElementById("victory-modal").classList.add("active"),await new Promise(o=>requestAnimationFrame(o)),await this.confetti.start(),e==null||e()}static resetSelectionWithDelay(e){setTimeout(()=>e.reset(),this.DURATIONS.SELECTION_RESET)}static updateCellStates(e,{add:t=[],remove:o=[]}){e.forEach(r=>{t.length&&requestAnimationFrame(()=>r.classList.add(...t)),o.length&&r.classList.remove(...o)})}static stopConfetti(){this.confetti.stop()}static cleanupAnimations(){const e=document.querySelectorAll(".animated-letter");e.length>0&&e.forEach(t=>t.remove())}static bindDebugEvents(){document.addEventListener("keydown",e=>{if(e.key.toLowerCase()==="t"&&this.confetti.test(),!isNaN(parseInt(e.key))&&e.key!=="0"){const t=parseInt(e.key)/10;this.confetti.test(t)}})}}be(oe,"DURATIONS",{LETTER_DELAY:50,LETTER_ANIMATION:300,VICTORY_DELAY:300}),be(oe,"confetti",{instance:null,async initialize(){const e=document.getElementById("confetti-canvas");if(!e){console.warn("❌ No se encontró el canvas");return}try{this.instance=mt.create(e,{resize:!0})}catch(t){console.error("❌ Error creando instancia:",t)}},async fire(e){this.instance||await this.initialize(),this.instance&&this.instance(e)},getColors(){const e=getComputedStyle(document.documentElement).getPropertyValue("--confetti-colors").trim();return e?e.split(",").map(t=>t.trim()):["#ffd700","#ff3939","#00ff7f","#4169e1","#ff69b4"]},stop(){this.instance&&(this.instance.reset(),this.instance=null)},start(){return new Promise(e=>{(async()=>{this.instance||await this.initialize();const o=this.getColors();await this.executeFirstWave(o),await new Promise(r=>setTimeout(r,250)),await this.executeSecondWave(o),e()})()})},async executeConfettiSequence(e){const t=this.getColors();await this.executeFirstWave(t),await new Promise(o=>setTimeout(o,250)),await this.executeSecondWave(t),e()},async executeFirstWave(e){this.fire({particleCount:100,spread:70,origin:{x:.1,y:.35},colors:e}),this.fire({particleCount:100,spread:70,origin:{x:.9,y:.35},colors:e}),k.isVibrationEnabled&&await _.vibrate("MEDIUM")},async executeSecondWave(e){this.fire({particleCount:150,spread:100,origin:{x:.5,y:.3},gravity:1.2,scalar:1.2,drift:0,ticks:300,colors:e}),k.isVibrationEnabled&&await _.vibrate("HEAVY")},test(e=.5,t=.35){this.fire({particleCount:50,spread:70,origin:{x:e,y:t},colors:this.getColors()})}});oe.bindDebugEvents();const xe=`/* stylelint-disable no-unknown-custom-properties */
...
}`,ht={categories:{basic:{themes:[{file:"8bitadventure.css",name:"8-Bit"},{file:"arcade.css",name:"Arcade"},{file:"battleready.css",name:"Battle"},{file:"classicconsole.css",name:"Classic"},{file:"cyberpunk.css",name:"Cyberpunk"},{file:"dark.css",name:"Dark",isDefault:!0},{file:"digitaldawn.css",name:"Dawn"},{file:"dreams.css",name:"Dreams"},{file:"elementalfury.css",name:"Elemental"},{file:"fantasy.css",name:"Fantasy"},{file:"forest.css",name:"Forest"},{file:"gameoverglow.css",name:"Game Over"},{file:"glitcheffect.css",name:"Glitch"},{file:"herojourney.css",name:"Hero"},{file:"light.css",name:"Light"},{file:"mint.css",name:"Mint"},{file:"mysticshadows.css",name:"Mystic"},{file:"neon.css",name:"Neon"},{file:"neonnostalgia.css",name:"Nostalgia"},{file:"odyssey.css",name:"Odyssey"},{file:"pixelparadise.css",name:"Paradise"},{file:"pixel.css",name:"Pixel"},{file:"retrorainbow.css",name:"Rainbow"},{file:"retroarcade.css",name:"Retro"},{file:"solarized.css",name:"Solarized"},{file:"stealth.css",name:"Stealth"},{file:"synthwave.css",name:"Synthwave"},{file:"technovibes.css",name:"Techno"},{file:"vintagevibes.css",name:"Vintage"}]},"modern-games":{themes:[{file:"bloodborne.css",name:"Bloodborne"},{file:"darksouls.css",name:"Dark Souls"},{file:"eldenring.css",name:"Elden Ring"},{file:"portal.css",name:"Portal"},{file:"sekiro.css",name:"Sekiro"},{file:"zelda-botw.css",name:"Zelda BOTW"}]},"retro-games":{themes:[{file:"amongus.css",name:"Among Us"},{file:"minecraft.css",name:"Minecraft"},{file:"pacman.css",name:"Pac-Man"},{file:"spaceinvaders.css",name:"Space Invaders"},{file:"tetris.css",name:"Tetris"}]}}};class pt{constructor(){this.currentTheme="dark",this.themesData=ht,this.availableThemes=new Map,this.categoryOrder=[],this.loadedStylesheets=new Set,this.loadedFonts=new Set,this.singleWordTerms=new Set(["pac-man"]),this._styleCache=new Map,this._previewStyles=new Map,this._themeLoadPromise=null,this._activeTheme=null,this._pendingThemeLoad=null,this._activeStyleElement=null,this._styleElement=document.createElement("style"),this._themesStyleElement=document.createElement("style"),this._themesStyleElement.id="theme-styles",this.loadThemeData(),this.themeGrid=document.querySelector(".theme-grid")}loadThemeData(){var e;if(!((e=this.themesData)!=null&&e.categories)){console.error("❌ No se encontraron datos de temas");return}this.categoryOrder=[],this.availableThemes.clear(),Object.entries(this.themesData.categories).forEach(([t,o])=>{this.categoryOrder.push(t),o.themes.forEach(r=>{this.availableThemes.set(r.file.replace(".css",""),r.name)})}),this.generateThemeGrid(),console.log("✅ Temas cargados:",{categorías:this.categoryOrder,temas:Array.from(this.availableThemes.entries())})}generateThemeGrid(){if(!this.themeGrid){console.error("❌ Elemento theme-grid no encontrado");return}this.themeGrid.innerHTML="",Object.entries(this.themesData.categories).forEach(([e,t])=>{const o=e.split("-").map(i=>i.charAt(0).toUpperCase()+i.slice(1)).join(" "),r=document.createElement("div");r.className="theme-category",r.textContent=o,this.themeGrid.appendChild(r),t.themes.forEach(i=>{const s=i.file.replace(".css",""),c=document.createElement("button");c.className="theme-option",c.dataset.theme=s;const d=document.createElement("div");d.className="preview-wrapper";const m=document.createElement("div");m.className="preview-cell";const S=document.createElement("div");S.className="preview-text",S.textContent="A",m.appendChild(S);const g=document.createElement("div");g.className="preview-mark",m.appendChild(g);const v=document.createElement("div");v.className="preview-title",v.textContent=i.name,d.appendChild(m),d.appendChild(v),c.appendChild(d),c.addEventListener("click",()=>this.setTheme(s)),this.themeGrid.appendChild(c)})})}async injectBaseStyles(){console.log("💉 Inyectando estilos base..."),this._styleElement.textContent=xe,document.head.appendChild(this._styleElement),this.loadThemeData(),this._themesStyleElement||(this._themesStyleElement=document.createElement("style"),this._themesStyleElement.id="theme-styles"),this._themesStyleElement.textContent=this.getThemeStyles(),document.head.appendChild(this._themesStyleElement),await new Promise(e=>{requestAnimationFrame(()=>setTimeout(e,100))})}getThemeStyles(){var t;if(!((t=this.themesData)!=null&&t.categories))return console.error("❌ No hay datos de temas"),"";const e=[];return Object.values(this.themesData.categories).forEach(o=>{o.themes.forEach(r=>{const i=r.file.replace(".css",""),s=this.findThemeStylesInCss(i);s&&e.push(s)})}),e.join(`

`)}findThemeStylesInCss(e){const t=`[data-theme='${e}']`,o=xe;let r=o.indexOf(t);if(r===-1)return null;let i=0,s=r,c=!1;for(let d=r;d<o.length;d++){const m=o[d];if(m==="{"?(i++,c=!0):m==="}"&&i--,c&&i===0){s=d+1;break}}return o.substring(r,s)}async initialize(){console.group("[ThemeSelector] Inicializando");try{const e=await k.get(k.KEYS.THEME,"dark");return console.log("Tema guardado:",e),this._pendingTheme=e,this.loadThemeData(),console.log("✅ ThemeSelector preparado"),!0}catch(e){return console.error("❌ Error:",e),document.documentElement.setAttribute("data-theme","dark"),!1}finally{console.groupEnd()}}async applyPendingTheme(){if(this._pendingTheme){console.log("🎨 Aplicando tema:",this._pendingTheme);try{await this.loadFontsForTheme(this._pendingTheme),document.documentElement.setAttribute("data-theme",this._pendingTheme),this._activeTheme=this._pendingTheme,await document.fonts.ready,await new Promise(e=>setTimeout(e,100)),this._pendingTheme=null,console.log("✅ Tema aplicado")}catch(e){console.error("❌ Error aplicando tema:",e)}}}async parseFonts(e){const t=/@import url\(['"]([^'"]+)['"]\);/g,o=new Set;let r;for(;(r=t.exec(e))!==null;)o.add(r[1]);return Array.from(o)}async loadFontsForTheme(e){try{const o=(await this.parseFonts(xe)).map(r=>{const i=document.createElement("link");return i.rel="stylesheet",i.href=r,i});await Promise.all(o.map(r=>new Promise((i,s)=>{r.onload=()=>i(),r.onerror=()=>s(),document.head.appendChild(r)}))),await document.fonts.ready,console.log("✅ Fuentes cargadas para el tema:",e)}catch(t){console.error("❌ Error cargando fuentes:",t)}}async preloadFontsForTheme(e){try{console.log("🔤 Precargando fuentes para:",e);const o=(await this.parseFonts(xe)).map(r=>{const i=document.createElement("link");return i.rel="stylesheet",i.href=r,i});await Promise.all(o.map(r=>new Promise(i=>{r.onload=i,r.onerror=i,document.head.appendChild(r)}))),await document.fonts.ready,console.log("✅ Fuentes cargadas")}catch(t){console.error("❌ Error cargando fuentes:",t)}}async setTheme(e){if(this._activeTheme===e)return!0;try{return console.group("🎨 Cambiando tema a:",e),await this.loadFontsForTheme(e),document.documentElement.setAttribute("data-theme",e),this._activeTheme=e,await document.fonts.ready,await k.setCurrentTheme(e),window.dispatchEvent(new CustomEvent("themechange",{detail:{theme:e}})),console.log("✅ Tema aplicado"),console.groupEnd(),!0}catch(t){return console.error("❌ Error aplicando tema:",t),console.groupEnd(),!1}}}class bt{constructor(e){this.titleElement=e,this.observer=new MutationObserver(()=>this.fit()),this.observe(),this.bindEvents()}observe(){this.observer.observe(this.titleElement,{childList:!0,characterData:!0,subtree:!0})}bindEvents(){window.addEventListener("resize",()=>{requestAnimationFrame(()=>this.fit())})}async fit(e=1){if(!this._fitInProgress){this._fitInProgress=!0;try{const r=this.titleElement,i=r.parentElement,s=N.getPlatform()==="android",c=getComputedStyle(i),d=i.clientWidth,m=parseFloat(c.paddingLeft)+parseFloat(c.paddingRight),S=s?d*.05:Math.min(16,d*.03),g=d-m-S;r.style="",await document.fonts.ready,r.style.display="inline-block",r.offsetWidth;const v=getComputedStyle(r),D=parseFloat(v.fontSize),I=document.createElement("span");I.style.cssText=`
                position: absolute;
                visibility: hidden;
                white-space: nowrap;
                font-family: ${v.fontFamily};
                font-size: ${D}px;
            `,I.textContent=r.textContent,document.body.appendChild(I);const B=I.offsetWidth;if(document.body.removeChild(I),e===1&&await _.logToNative(`📏 [${s?"Android":"Web"}] Ajuste inicial`,{texto:r.textContent,contenedor:Math.round(d),disponible:Math.round(g),anchoActual:Math.round(B)}),B>g){const x=s?.5:.85,L=.15*(e-1),U=Math.max(.3,x-L),F=g/B*U*.9,q=s?14:18,K=s?d*.05:d*.08;let R=Math.floor(Math.max(q,Math.min(D*F,K)));for(await _.logToNative("📊 Cálculos",{factorEscala:U,escalaFinal:F.toFixed(2),fuenteMinima:Math.round(q),fuenteNueva:R,maximoPermitido:Math.round(K)});R>=q;){r.style.fontSize=`${R}px`,r.offsetWidth,await new Promise(M=>requestAnimationFrame(M)),I.style.fontSize=`${R}px`,document.body.appendChild(I);const V=I.offsetWidth;document.body.removeChild(I);const P={anchoFinal:Math.round(V),anchoDisponible:Math.round(g),ajustado:V<=g,porcentajeReduccion:Math.round((1-R/D)*100)};if(await _.logToNative("📐 Resultado",P),V<=g){await _.logToNative("✅ Ajuste completado");return}if(R=Math.floor(R*.9),R<q)break}if(e<3)return await _.logToNative("⚠️ Reintentando ajuste..."),await new Promise(V=>setTimeout(V,50)),this.fit(e+1)}else await _.logToNative("✅ No necesita ajuste")}catch(r){console.error("Error ajustando título:",r)}finally{this._fitInProgress=!1,this.titleElement.style.display=""}}}destroy(){this.observer.disconnect()}}const ge=class ge{constructor(){if(ge.instance)return ge.instance;ge.instance=this,console.group("🎮 GameState Constructor");const e="base-styles";if(!document.getElementById(e)){console.log("💉 Inyectando estilos base...");const t=document.createElement("style");t.id=e,t.textContent=`
                @keyframes rotation {
            ...
            `,document.head.appendChild(t)}document.getElementById(e)&&document.getElementById(e).remove(),window.themeSelector||(window.themeSelector=new pt),this.themeSelector=window.themeSelector,console.log("✅ GameState inicializado"),console.groupEnd(),this._lastAppliedTheme=null}async initialize(){console.group("🔄 Inicialización");try{await this.themeSelector.injectBaseStyles(),await Promise.all([_.initialize(),k.initialize()]),this.initializeElements(),this.initializeState(),this.initializeBoard();const e=Q[0],t=await k.getCurrentLevel(),o=t&&ie[t]?t:e;this.currentLevel={...ie[o],id:o,name:ie[o].name},this.bindEvents(),await this.showContent(),await this.updateAllWithoutTitleFit(o),console.log("✅ Inicialización completada")}catch(e){console.error("❌ Error:",e),this.handleInitializationError()}console.groupEnd()}handleInitializationError(){const e=Q[0];console.log("Recuperando con nivel por defecto:",e),this.currentLevel={...ie[e],id:e,name:ie[e].name},this.initializeElements(),this.initializeState(),this.initializeBoard(),this.updateAll(e),this.showContent()}async onAppPause(){this.timer&&!this.timer.isPaused&&(this.pauseTimer(),this._wasTimerRunning=!0),await k.setCurrentLevel(this.currentLevel.id)}onAppResume(){var e;this.checkAndHandleDataReset(),this._wasTimerRunning&&((e=this.timer)!=null&&e.isPaused)&&(this.resumeTimer(),this._wasTimerRunning=!1)}async saveGameState(){try{await k.setCurrentLevel(this.currentLevel.id)}catch(e){console.error("Error guardando estado:",e)}}async checkAndHandleDataReset(){try{await k.get(k.KEYS.THEME)||await this.handleDataReset()}catch(e){console.error("Error verificando datos:",e),await this.handleDataReset()}}async handleDataReset(){try{await k.resetToDefaults(),await this.themeSelector.initialize(),await this.loadLevel(Q[0])}catch(e){console.error("Error reinicializando datos:",e)}}async initializeGame(){await k.initialize();const e=await k.get(k.KEYS.CURRENT_LEVEL,Q[0]);this.currentLevel={...ie[e],id:e}}async initPhase1(){try{await this.themeSelector.initialize(),this.initializeElements(),this.initializeState(),this.initializeBoard(),this.bindEvents()}catch(e){console.error("Error in initPhase1:",e),document.documentElement.setAttribute("data-theme","dark")}}async initPhase2(){const e=await k.get(k.KEYS.CURRENT_LEVEL,Q[0]);this.currentLevel={...ie[e],id:e},this.updateAll(this.currentLevel.id),this.showContent()}setTheme(e){return this.themeSelector.setTheme(e)}async handleThemeChange(e){console.group("🔄 Cambio de tema:",e);try{if(this._lastAppliedTheme===e){console.log("⏩ Tema ya aplicado, omitiendo...");return}console.log("🎨 Aplicando tema..."),await this.themeSelector.setTheme(e),this._lastAppliedTheme=e,console.log("🔄 Reseteando estilos del título..."),this.titleElement.style="",console.log("⌛ Esperando fuentes..."),await document.fonts.ready;const t=getComputedStyle(this.titleElement);console.log("🔤 Precargando fuente:",t.fontFamily),await document.fonts.load(`${t.fontSize} ${t.fontFamily}`),this.titleFitter&&(console.log("📏 Ajustando título..."),await this.titleFitter.fit()),console.log("📝 Actualizando lista de palabras..."),this.updateWordList(),console.log("✅ Cambio de tema completado")}catch(t){console.error("❌ Error al cambiar tema:",t)}console.groupEnd()}async showContent(){var e;console.group("👁️ Mostrando Contenido");try{const t=document.querySelector(".js-loading-overlay"),o=t.querySelector(".progress-bar");o.style.transform="scaleX(0)",await new Promise(i=>requestAnimationFrame(i)),document.documentElement.setAttribute("data-theme","dark"),await this.themeSelector.injectBaseStyles(),o.style.animationPlayState="running",await this.themeSelector.initialize();const r=await k.get(k.KEYS.THEME,"dark");await this.themeSelector.setTheme(r),await document.fonts.ready,await new Promise(i=>{o.addEventListener("animationend",i,{once:!0})}),t.classList.add("fade-out")}catch(t){console.error("❌ Error:",t),(e=document.querySelector(".js-loading-overlay"))==null||e.remove()}finally{document.body.classList.remove("js-loading"),console.groupEnd()}}async updateAllWithoutTitleFit(e){var t;(t=this.currentLevel)!=null&&t.data&&(this.updateBoard(),this.updateTitleContent(),this.updateWordList(),this.updateUnusedLetters(),this.updateLevelNumber(e),this.resetTimer(),this.startTimer())}updateTitleContent(){var r;if(!this.titleElement||!((r=this.currentLevel)!=null&&r.name))return;const e="user-select: text; -webkit-user-select: text; -moz-user-select: text;",o=N.getPlatform()==="android"?"16px":"24px";this.titleElement.textContent=this.currentLevel.name,this.titleElement.style.cssText=`${e}; font-size: ${o};`}async fitTitle(){if(!(this._titleFitInProgress||!this.titleFitter))try{this._titleFitInProgress=!0,await this.titleFitter.fit()}finally{this._titleFitInProgress=!1}}initializeElements(){try{const e={titleContainer:document.querySelector(".title-container"),titleElement:document.querySelector(".title"),board:document.querySelector(".board"),wordList:document.querySelector(".word-list"),levelNumber:document.querySelector(".level-number"),timerElement:document.querySelector(".timer")};if(!e.titleElement||!e.board)throw new Error("Elementos críticos no encontrados");if(Object.entries(e).forEach(([t,o])=>{o||console.warn(`Elemento ${t} no encontrado`),this[t]=o}),this.timer={element:this.timerElement,startTime:0,elapsed:0,interval:null,isPaused:!1},this.titleElement){this.titleFitter=new bt(this.titleElement);const t=N.getPlatform()==="android",o="user-select: text; -webkit-user-select: text; -moz-user-select: text;",r=t?"16px":"24px";this.titleElement.style.cssText=`${o}; font-size: ${r};`}}catch(e){throw console.error("Error inicializando elementos:",e),e}}initializeState(){this.currentLevel=null,this.foundWords=new Set,this.usedLetters=new Set,this.availableThemes=new Map,this.themeDisplayNames=new Map,this.categoryOrder=[],this.selectionManager=new ft(this.board,null,e=>this.onSelectionUpdate(e))}onSelectionUpdate(e){this.checkWord(e)&&oe.resetSelectionWithDelay(this.selectionManager)}initializeBoard(){const e=document.createDocumentFragment();for(let t=1;t<=16;t++){const o=String.fromCharCode(96+Math.ceil(t/4)),r=(t-1)%4+1,i=`${o}${r}`,s=document.createElement("div");s.className="cell",s.id=`tile-${i}`,s.innerHTML=`
                <div class="hitbox" data-position="${i}"></div>
                <div class="mark" id="mark-${i}"></div>
                <div class="text" id="letter-${i}"></div>
            `,e.appendChild(s)}this.board.appendChild(e)}updateBoard(){var o;if(!((o=this.currentLevel)!=null&&o.data)){console.warn("No hay nivel actual o datos para mostrar");return}const e=Array(4).fill().map(()=>Array(4).fill("")),t=Array(16).fill().map((r,i)=>{const s=String.fromCharCode(96+Math.ceil((i+1)/4)),c=i%4+1;return`${s}${c}`});t.forEach(r=>document.getElementById(`tile-${r}`).classList.remove("found-temp","unused")),Object.entries(this.currentLevel.data).forEach(([r,i])=>{r.replace(/\s+/g,"").split("").forEach((s,c)=>{const d=i.slice(c*2,c*2+2);if(d.length===2){const m=d.charCodeAt(0)-97,S=parseInt(d[1])-1;m>=0&&m<4&&S>=0&&S<4&&!e[m][S]&&(e[m][S]=s)}})}),t.forEach((r,i)=>{document.getElementById(`letter-${r}`).textContent=e[Math.floor(i/4)][i%4]})}resetSelection(){this.selectionManager.reset()}async loadLevel(e){oe.stopConfetti(),this.resetControls(),document.querySelectorAll(".animated-letter").forEach(t=>t.remove()),this.currentLevel={...ie[e],id:e},[this.foundWords,this.usedLetters].forEach(t=>t.clear()),this.resetSelection(),this.updateAll(e),await k.setCurrentLevel(e)}updateAll(e){var t;if(!((t=this.currentLevel)!=null&&t.data)){console.error("❌ No hay nivel actual para actualizar",{levelId:e,currentLevel:this.currentLevel});return}this.updateBoard(),this.updateTitle(),this.titleFitter&&requestAnimationFrame(()=>this.titleFitter.fit()),this.updateWordList(),this.updateUnusedLetters(),this.updateLevelNumber(e),this.resetTimer(),this.startTimer()}updateTitle(){var e;if(!this.titleElement&&(console.error("Título no encontrado, reinicializando elementos..."),this.initializeElements(),!this.titleElement)){console.error("No se pudo recuperar el elemento título");return}if(!((e=this.currentLevel)!=null&&e.name)){console.error("Nivel actual sin nombre:",this.currentLevel);return}try{const t="user-select: text; -webkit-user-select: text; -moz-user-select: text;";this.titleElement.textContent=this.currentLevel.name;const r=N.getPlatform()==="android"?"16px":"24px";this.titleElement.style.cssText=`${t}; font-size: ${r};`,this.titleFitter&&requestAnimationFrame(()=>this.titleFitter.fit()),console.log("Título actualizado:",{contenido:this.currentLevel.name,elemento:this.titleElement.textContent,estilos:this.titleElement.style.cssText})}catch(t){console.error("Error actualizando título:",t)}}updateWordList(){var r;if(!this.wordList||!((r=this.currentLevel)!=null&&r.data)){console.warn("No hay lista de palabras o nivel actual");return}this.wordList.innerHTML="";const e=document.createDocumentFragment(),t=Object.keys(this.currentLevel.data).sort((i,s)=>i.localeCompare(s)),o=document.createElement("div");o.className="word word-measure",o.style.cssText=`
            position: absolute;
            visibility: hidden;
            height: auto;
            width: auto;
            white-space: nowrap;
        `,document.body.appendChild(o),t.forEach((i,s)=>{const c=document.createElement("div");c.className="word",c.setAttribute("data-index",s);const d=this.foundWords.has(i),m=document.createElement("span");if(o.textContent=i+"M",c.style.setProperty("--word-content-width",`${o.offsetWidth}px`),d)c.classList.add("found"),m.textContent=i;else{const S=i.split(" ").map(g=>g.length);m.innerHTML=`<span class="word-length">${S.join(", ")}</span>`}c.appendChild(m),e.appendChild(c)}),document.body.removeChild(o),this.wordList.appendChild(e)}checkWord(e){if(!(e!=null&&e.length))return!1;const t=e.join("");for(const[o,r]of Object.entries(this.currentLevel.data))if(r===t&&!this.foundWords.has(o)){const i=Object.keys(this.currentLevel.data).sort((c,d)=>c.localeCompare(d)).indexOf(o),s=this.wordList.querySelector(`[data-index="${i}"]`);return s!=null&&s.classList.contains("found")?!1:(this.foundWords.add(o),s&&(s.classList.add("found","found-initial"),s.addEventListener("animationend",()=>{s.classList.remove("found-initial")},{once:!0})),this.animateFound(e),this.resetControls(),!0)}return!1}async animateFound(e){var r;const t=e.join(""),o=(r=Object.entries(this.currentLevel.data).find(([,i])=>i===t))==null?void 0:r[0];if(o){k.isVibrationEnabled&&await _.vibrate(),this.foundWords.size===Object.keys(this.currentLevel.data).length&&(this.pauseTimer(),document.getElementById("final-time").textContent=this.timer.element.textContent);const i=Object.keys(this.currentLevel.data).sort((c,d)=>c.localeCompare(d)).indexOf(o),s=this.wordList.querySelector(`[data-index="${i}"]`);if(!s)return;await oe.animateWordFound(e,s,o),this.updateUnusedLetters(),this.foundWords.size===Object.keys(this.currentLevel.data).length&&this.onLevelComplete()}}updateUnusedLetters(){var t;this.usedLetters.clear(),Object.entries(this.currentLevel.data).forEach(([o,r])=>{if(!this.foundWords.has(o))for(let i=0;i<r.length;i+=2){const s=r.slice(i,i+2);s.length===2&&this.usedLetters.add(s)}});const e=[];for(let o=1;o<=16;o++){const r=String.fromCharCode(96+Math.ceil(o/4)),i=(o-1)%4+1,s=`${r}${i}`,c=document.getElementById(`tile-${s}`);if(!this.usedLetters.has(s))e.push(s),(t=c.querySelector(".hitbox"))==null||t.remove();else if(oe.updateCellStates([c],{remove:["unused"]}),!c.querySelector(".hitbox")){const d=document.createElement("div");d.className="hitbox",d.dataset.position=s,c.insertBefore(d,c.firstChild)}}e.length&&oe.animateUnusedCells(e)}onLevelComplete(){k.isVibrationEnabled&&_.vibrate("HEAVY"),oe.animateVictory(()=>{this.showVictoryModal()})}bindEvents(){Object.entries({touchstart:"handlePointerDown",touchmove:"handleTouchMove",touchend:"handlePointerUp",touchcancel:"handlePointerUp",mousedown:"handlePointerDown",mousemove:"handlePointerMove",mouseup:"handlePointerUp",mouseleave:"handlePointerOut",mouseenter:"handlePointerEnter"}).forEach(([i,s])=>{this.board.addEventListener(i,c=>this.selectionManager[s].call(this.selectionManager,c),{passive:!1})}),window.addEventListener("themechange",i=>{this.handleThemeChange(i.detail.theme)}),this.bindModalEvents(),window.addEventListener("resize",()=>this.selectionManager.drawLine()),document.addEventListener("click",i=>{const s=i.target;s.closest("#victory-modal")||s.closest(".modal-content")||s.closest(".menu")||s.closest(".board")||(this.selectionManager.reset(),s.closest(".modal-overlay")&&this.handleModalClose())}),new ResizeObserver(()=>{requestAnimationFrame(()=>{oe.cleanupAnimations(),this.updateWordList()})}).observe(document.documentElement);const t={"vibration-toggle":async()=>{try{const i=document.getElementById("vibration-toggle"),s=!k.isVibrationEnabled;await k.setVibrationEnabled(s),i.textContent=s?"Desactivar Vibración":"Activar Vibración",s&&await _.vibrate("LIGHT")}catch(i){console.error("Error al cambiar estado de vibración:",i)}},"test-notification":async()=>{console.group("🔔 Test Notificación");try{console.log("1. Inicializando notificaciones..."),await _.initializeNotifications(),console.log("2. Activando notificaciones..."),await k.setNotificationEnabled(!0),console.log("3. Intentando enviar notificación..."),await _.sendNotification("¡Hora de jugar!","Te esperan nuevos desafíos en GameSalad"),console.log("✅ Notificación enviada con éxito")}catch(i){console.error("❌ Error en notificación:",i)}finally{console.groupEnd()}}},o=document.getElementById("vibration-toggle");o&&(o.textContent=k.isVibrationEnabled?"Desactivar Vibración":"Activar Vibración"),Object.entries(t).forEach(([i,s])=>{var c;(c=document.getElementById(i))==null||c.addEventListener("click",s)}),Object.entries({"reset-game":()=>{this.resetTimer(),this.loadLevel(this.currentLevel.id),document.getElementById("modal").classList.remove("active")},"restart-level":()=>{this.resetTimer(),this.loadLevel(this.currentLevel.id),document.getElementById("victory-modal").classList.remove("active")},"next-level":()=>{const s=Q.indexOf(this.currentLevel.id)+1;s<Q.length?(this.resetTimer(),this.loadLevel(Q[s]),document.getElementById("victory-modal").classList.remove("active")):(this.resetTimer(),this.loadLevel(Q[0]),document.getElementById("victory-modal").classList.remove("active"))}}).forEach(([i,s])=>{var c;(c=document.getElementById(i))==null||c.addEventListener("click",s)}),document.addEventListener("appPause",()=>{this.onAppPause()}),document.addEventListener("appResume",()=>{this.onAppResume()}),document.addEventListener("visibilitychange",()=>{document.hidden?this.onAppPause():this.onAppResume()})}bindModalEvents(){var i;const e={menu:document.querySelector(".menu"),modal:document.getElementById("modal"),themeModal:document.getElementById("theme-modal"),victoryModal:document.getElementById("victory-modal")},t=()=>Object.values(e).some(s=>s==null?void 0:s.classList.contains("active")),o=s=>{(s==null?void 0:s.id)!=="victory-modal"&&(s==null||s.classList.remove("active"),t()||this.resumeTimer())};Object.entries({menu:()=>{e.modal.classList.add("active"),this.pauseTimer()},"theme-button":()=>{e.modal.classList.remove("active"),e.themeModal.classList.add("active")},"back-button":()=>{e.themeModal.classList.remove("active"),e.modal.classList.add("active")}}).forEach(([s,c])=>{var d;(d=document.querySelector(s==="menu"?".menu":`#${s}`))==null||d.addEventListener("click",m=>{m.stopPropagation(),c()})}),(i=e.victoryModal)==null||i.addEventListener("click",s=>{s.target===e.victoryModal&&s.stopPropagation()}),document.querySelectorAll(".modal-overlay").forEach(s=>{s.id!=="victory-modal"&&s.addEventListener("click",c=>{c.target===s&&(o(s),t()||this.resumeTimer())})})}handleModalClose(){const e=document.querySelector(".modal-overlay.active:not(#victory-modal)");e&&(e.classList.remove("active"),document.querySelector(".modal-overlay.active")||this.resumeTimer())}startTimer(){this.timer.startTime=Date.now()-this.timer.elapsed,this.timer.isPaused=!1,this.timer.interval&&clearInterval(this.timer.interval),this.timer.interval=setInterval(()=>{this.timer.isPaused||(this.timer.elapsed=Date.now()-this.timer.startTime,this.updateTimerDisplay())},100)}pauseTimer(){this.timer.isPaused||(this.timer.isPaused=!0,this.timer.elapsed=Date.now()-this.timer.startTime,this.saveGameState())}resumeTimer(){this.timer.isPaused&&(this.timer.isPaused=!1,this.timer.startTime=Date.now()-this.timer.elapsed)}resetTimer(){this.timer.interval&&clearInterval(this.timer.interval),this.timer.elapsed=0,this.timer.isPaused=!1,this.updateTimerDisplay()}updateTimerDisplay(){const e=Math.floor(this.timer.elapsed/1e3),t=Math.floor(e/60),o=String(e%60).padStart(2,"0"),r=String(t).padStart(2,"0");this.timer.element.textContent=`${r}:${o}`}showVictoryModal(){this.pauseTimer(),document.getElementById("final-time").textContent=this.timer.element.textContent,document.getElementById("victory-modal").classList.add("active")}updateLevelNumber(e){if(!this.levelNumberElement&&(this.levelNumberElement=document.querySelector(".level-number"),!this.levelNumberElement)){console.error("No se pudo encontrar/crear el número de nivel");return}const t=Q.indexOf(e)+1;if(!t){console.warn("ID de nivel inválido:",e);return}requestAnimationFrame(()=>{this.levelNumberElement.textContent=`#${t}`,this.levelNumberElement.style.cssText=`
                display: block !important;
                visibility: visible !important;
                opacity: 1 !important;
            `})}resetControls(){this.selectionManager.resetControls()}};be(ge,"instance",null);let Pe=ge;const Be=async()=>{var l;try{await new Pe().initialize()}catch(e){console.error("Error:",e),(l=document.querySelector(".js-loading-overlay"))==null||l.remove(),document.body.classList.remove("js-loading")}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Be):Be();export{Ee as I,Ce as N,We as W};
